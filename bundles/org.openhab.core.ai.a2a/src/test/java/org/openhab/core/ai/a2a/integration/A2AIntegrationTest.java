...
class A2AIntegrationTest {
    ...
    void testSkillRegistryIntegration() throws Exception {
        ...
        for (var skill : skills) {
            ...
            if ("openhab.items.list".equals(name)) hasItemsSkill = true;
            if ("openhab.persistence.manage".equals(name)) hasPersistenceSkill = true;
            if ("openhab.things.list".equals(name)) hasThingsSkill = true;
        }
    ...
    void testRealA2AAgentIntegration() throws Exception {
        ...
        try {
            ...
            System.out.println("Real A2A Agent: " + agentCard.get("name").asText() + " v" + agentCard.get("version").asText());
