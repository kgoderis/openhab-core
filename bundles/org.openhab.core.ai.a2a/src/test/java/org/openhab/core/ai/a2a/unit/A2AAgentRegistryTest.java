...
import org.openhab.core.ai.a2a.internal.A2AAgentRegistry.AgentCommunicationProtocol;
import org.openhab.core.ai.a2a.internal.A2AAgentRegistry.AgentRegistrationResult;
import org.openhab.core.ai.a2a.internal.A2AAgentRegistry.AgentSecurityContext;
import org.openhab.core.ai.a2a.internal.A2AAgentRegistry.AgentValidationResult;

import io.a2a.spec.Task;
import io.a2a.spec.TaskStatusUpdateEvent;
import org.openhab.core.ai.a2a.internal.A2AAgentRegistry.AgentMessage;
import org.openhab.core.ai.a2a.internal.A2AAgentRegistry.MessageHandler;
import org.openhab.core.ai.a2a.internal.A2AAgentRegistry.MessageResponse;
import org.openhab.core.ai.a2a.internal.A2AAgentRegistry.MessageStatus;

/**
 * Unit tests for A2AAgentRegistry
 * 
 * @author Karel Goderis - Initial Contribution
 */
@ExtendWith(MockitoExtension.class)
public class A2AAgentRegistryTest {
    ...
    private TestA2AAgent testAgent;

    /**
     * Simple test implementation of A2AAgent to avoid mocking issues
     */
    private static class TestA2AAgent implements A2AAgent {
        private final String id;
        private boolean running = false;
        private final Set<String> capabilities;

        public TestA2AAgent(String id) {
            this.id = id;
            this.capabilities = Set.of("test-capability");
        }

        public TestA2AAgent(String id, Set<String> capabilities) {
            this.id = id;
    ...
    public void setUp() {
        ...
        testAgent = new TestA2AAgent(TEST_AGENT_ID);
    }
    ...
    public void testAgentRegistrationWithDuplicateId() {
        ...
        TestA2AAgent testAgent2 = new TestA2AAgent(TEST_AGENT_ID, Set.of("different-capability"));
    ...
    public void testFindAgentsWithCapability() {
        AgentSecurityContext securityContext = new AgentSecurityContext(Set.of(TEST_USER_ID), 
            Set.of(TEST_USER_ID + ":read"));
        registry.registerAgent(TEST_AGENT_ID, testAgent, securityContext);
        TestA2AAgent testAgent2 = new TestA2AAgent(TEST_AGENT_ID_2, Set.of("different-capability"));
        ...
        List<String> agentsWithDifferentCapability = registry.findAgentsWithCapability("different-capability", TEST_USER_ID);
