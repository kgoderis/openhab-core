 ...
 * @since 1.0.0
 */
@Component(service = A2APushNotificationManager.class)
public class A2APushNotificationManager {

    private static final Logger logger = LoggerFactory.getLogger(A2APushNotificationManager.class);
