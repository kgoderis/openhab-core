...
public class GetAddonAction implements AIAction {
    ...
    public AIActionValidationResult validateParameters(Map<String, Object> parameters) {
        try {
            if (!parameters.containsKey("addonId")) {
                return AIActionValidationResult.invalid(List.of("Missing required parameter: addonId"));
            }

            String addonId = (String) parameters.get("addonId");
            if (addonId == null || addonId.trim().isEmpty()) {
                return AIActionValidationResult.invalid(List.of("addonId cannot be null or empty"));
            }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        try {
            ...
            throw new AIActionException(ACTION_ID, "Failed to get addon information: " + e.getMessage(), e);
        }
    }
