package org.openhab.core.ai.common.actions.resources;
...
/**
 * AIAction for managing resources in the openHAB system.
 * 
...
public class ResourceManagementAction implements AIAction {
        ...
        switch (operation) {
            ...
            case "create":
                if (parameters.get("resourceData") == null) {
                    return AIActionValidationResult.invalid(List.of("Resource data is required for create operation"));
                }
                break;
            case "list":
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            Map<String, Object> result = switch (operation) {
                ...
                default -> throw new AIActionException(ACTION_ID, "Invalid operation: " + operation);
            };
            ...
            throw new AIActionException(ACTION_ID, "Resource management operation failed: " + e.getMessage(), e);
        }
    }
