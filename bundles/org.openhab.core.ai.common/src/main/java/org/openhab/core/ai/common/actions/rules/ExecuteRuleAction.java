...
/**
 * AIAction for manually executing openHAB Rules.
 * This action allows manual triggering of rule execution with custom context data.
 * 
 * 
 */
@Component(service = AIAction.class, immediate = true)
public class ExecuteRuleAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            if (rule == null) {
                ...
                return AIActionResult.success(result, System.currentTimeMillis() - startTime);
            }
            ...
            throw new AIActionException(getActionId(), "Failed to execute rule: " + e.getMessage(), e);
        }
    }
