...
public class ThingConfigurationAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to manage Thing configuration: " + e.getMessage(), e);
        }
    }
    ...
    private Map<String, Object> performConfigurationAction(String thingUID, String action, Map<?, ?> configuration,
        ...
        if (!thingExists(thingUID)) {
            throw new AIActionException(getActionId(), "Thing not found: " + thingUID, "RESOURCE_NOT_FOUND");
        }
