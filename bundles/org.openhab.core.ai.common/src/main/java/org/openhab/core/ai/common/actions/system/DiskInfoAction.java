...
/**
 * AIAction for retrieving detailed disk information including space usage, file systems, and storage analysis.
 * 
 * This action provides comprehensive disk diagnostics using real Java File APIs.
 */
@Component(service = AIAction.class, immediate = true)
public class DiskInfoAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            throw new AIActionException(ACTION_ID, "Failed to collect disk information: " + e.getMessage(), e);
        }
    }
