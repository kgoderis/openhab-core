...
public class GetRuleActionsAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to get rule actions: " + e.getMessage(), e);
        }
    }
    ...
    private Map<String, Object> convertActionToMap(Action action, boolean includeConfiguration,
            boolean includeExecutionDetails, boolean includeTypeInfo) {
