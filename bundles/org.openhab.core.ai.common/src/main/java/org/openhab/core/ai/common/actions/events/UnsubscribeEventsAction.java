...
public class UnsubscribeEventsAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        try {
            ...
            throw new AIActionException(ACTION_ID, "Failed to unsubscribe from events: " + e.getMessage(), e);
        }
    }
    ...
    private Map<String, Object> unsubscribeFromEvents(Map<String, Object> parameters, AIActionContext context) {
