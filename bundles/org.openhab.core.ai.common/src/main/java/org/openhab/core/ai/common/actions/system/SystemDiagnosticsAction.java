...
public class SystemDiagnosticsAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            return AIActionResult.success(diagnostics, executionTime);

        } catch (Exception e) {
            long executionTime = System.currentTimeMillis() - startTime;
            logger.error("System diagnostics action failed", e);
            throw new AIActionException(ACTION_ID, "Failed to collect diagnostics: " + e.getMessage(), e);
        }
    }
