...
public class MultiStepReasoningResult {
    ...
    private final List<AIActionResult> toolCalls;
    ...
    public List<AIActionResult> getToolCalls() {
        return toolCalls;
    }
    ...
    public static class Builder {
        ...
        private List<AIActionResult> toolCalls = List.of();
        ...
        public Builder toolCalls(List<AIActionResult> toolCalls) {
