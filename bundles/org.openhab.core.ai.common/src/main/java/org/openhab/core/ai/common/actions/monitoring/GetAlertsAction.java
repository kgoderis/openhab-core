...
/**
 * AIAction for retrieving and managing alerts and notifications in openHAB monitoring.
 */
@Component(service = AIAction.class, immediate = true)
public class GetAlertsAction implements AIAction {
        ...
        try {
            ...
            switch (action) {
                ...
                case "clear_alert":
                    ...
                    break;
                default:
                    throw new AIActionException(ACTION_ID, "Unknown action: " + action);
            }
            ...
            throw new AIActionException(ACTION_ID, "Failed to get alerts: " + e.getMessage(), e);
        }
    }
