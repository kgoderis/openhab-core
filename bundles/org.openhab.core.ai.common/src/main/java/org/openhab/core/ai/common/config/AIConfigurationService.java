...
public interface AIConfigurationService {
     ...
     */
    AIProtocolConfiguration getProtocolConfiguration(String protocol);
     ...
     */
    boolean updateProtocolConfiguration(String protocol, AIProtocolConfiguration configuration);
     ...
     */
    void addConfigurationChangeListener(AIConfigurationChangeListener listener);
     ...
     */
    void removeConfigurationChangeListener(AIConfigurationChangeListener listener);
