...
/**
 * AIAction for updating existing openHAB Rules.
 * This action updates rule properties, triggers, conditions, and actions.
 * 
 * 
 */
@Component(service = AIAction.class, immediate = true)
public class UpdateRuleAction implements AIAction {
    ...
    public AIActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (ruleRegistry.get(ruleUID) == null) {
            return AIActionValidationResult
                    .invalid(java.util.List.of("Rule with UID '" + ruleUID + "' does not exist"));
        }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to update rule: " + e.getMessage(), e);
        }
    }
