...
public class CheckAddonCompatibilityAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        try {
            ...
            throw new AIActionException(ACTION_ID, "Failed to check addon compatibility: " + e.getMessage(), e);
        }
    }
