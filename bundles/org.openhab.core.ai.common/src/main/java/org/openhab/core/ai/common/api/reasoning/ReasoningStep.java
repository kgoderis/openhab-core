package org.openhab.core.ai.common.api.reasoning;
...
public class ReasoningStep {
    ...
    private final List<AIActionContext> toolCalls;
    ...
    public List<AIActionContext> getToolCalls() {
        return toolCalls;
    }
    ...
    public static class Builder {
        ...
        private List<AIActionContext> toolCalls = List.of();
        ...
        public Builder toolCalls(List<AIActionContext> toolCalls) {
