...
public class SearchItemsAction implements AIAction {
    ...
    public AIActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (maxResultsObj != null) {
            if (!(maxResultsObj instanceof Integer)) {
                return AIActionValidationResult.invalid(List.of("maxResults must be an integer"));
            }
            Integer maxResults = (Integer) maxResultsObj;
            if (maxResults <= 0 || maxResults > 1000) {
                return AIActionValidationResult.invalid(List.of("maxResults must be between 1 and 1000"));
            }
        }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to search items: " + e.getMessage(), e);
        }
    }
