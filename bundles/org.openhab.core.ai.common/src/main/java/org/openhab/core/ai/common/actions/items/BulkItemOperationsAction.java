...
public class BulkItemOperationsAction implements AIAction {
    ...
    public AIActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (itemNamesObj == null || !(itemNamesObj instanceof List)) {
            return AIActionValidationResult.invalid(List.of("itemNames must be an array"));
        }

        @SuppressWarnings("unchecked")
        List<String> itemNames = (List<String>) itemNamesObj;
        if (itemNames.isEmpty()) {
            return AIActionValidationResult.invalid(List.of("itemNames cannot be empty"));
        }

        if (itemNames.size() > 100) {
            return AIActionValidationResult.invalid(List.of("Cannot operate on more than 100 items at once"));
        }
        ...
        switch (operation) {
            ...
            case "sendCommand":
                ...
                if (value == null || value.trim().isEmpty()) {
                    return AIActionValidationResult
                            .invalid(List.of("Value is required for " + operation + " operation"));
                }
                break;
            case "setMetadata":
                String namespace = (String) parameters.get("namespace");
                if (namespace == null || namespace.trim().isEmpty()) {
                    return AIActionValidationResult.invalid(List.of("Namespace is required for setMetadata operation"));
                }
            ...
            case "setTags":
                ...
                if (tagsObj == null || !(tagsObj instanceof Map)) {
                    return AIActionValidationResult.invalid(List.of("Tags must be an object for setTags operation"));
                }
                break;
        }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to perform bulk operations: " + e.getMessage(), e);
        }
    }
