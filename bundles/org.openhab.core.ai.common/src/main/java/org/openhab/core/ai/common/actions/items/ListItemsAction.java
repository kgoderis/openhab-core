...
/**
 * AIAction for listing openHAB Items with comprehensive filtering and metadata.
...
public class ListItemsAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to list Items: " + e.getMessage(), e);
        }
    }
    ...
    private Map<String, Object> listItems(String type, String state, String group, String tag, String category,
            ...
            boolean includeState, String sortBy, String sortOrder, int limit, int offset) throws AIActionException {

        if (itemRegistry == null) {
            throw new AIActionException(getActionId(), "ItemRegistry not available");
        }
