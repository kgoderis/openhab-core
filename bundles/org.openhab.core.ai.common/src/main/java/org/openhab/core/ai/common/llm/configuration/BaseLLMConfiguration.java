 ...
 */
@NonNullByDefault
public abstract class BaseLLMConfiguration {
    ...
    protected BaseLLMConfiguration(boolean enabled, String modelName, double temperature, int maxTokens, int timeoutMs,
            int retryAttempts, @Nullable String systemPrompt) {
