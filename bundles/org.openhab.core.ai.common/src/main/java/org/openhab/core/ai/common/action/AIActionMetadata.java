...
public class AIActionMetadata {
    ...
    private AIActionMetadata(Builder builder) {
    ...
    public static class Builder {
        ...
        public AIActionMetadata build() {
            return new AIActionMetadata(this);
        }
    }
    ...
    public String toString() {
        return String.format("AIActionMetadata{version='%s', author='%s', tags=%s}", version, author, tags);
    }
}
