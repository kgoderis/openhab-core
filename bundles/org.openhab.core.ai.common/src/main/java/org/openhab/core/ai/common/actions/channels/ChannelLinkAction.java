...
public class ChannelLinkAction implements AIAction {
    ...
    public AIActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (channelUID == null || channelUID.trim().isEmpty()) {
            return AIActionValidationResult.invalid(List.of("channelUID is required and cannot be empty"));
        }

        String itemName = (String) parameters.get("itemName");
        if (itemName == null || itemName.trim().isEmpty()) {
            return AIActionValidationResult.invalid(List.of("itemName is required and cannot be empty"));
        }
        ...
        try {
            ...
            return AIActionValidationResult.invalid(List.of("Invalid channelUID format: " + channelUID));
        }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            long executionTime = System.currentTimeMillis() - startTime;
            throw new AIActionException(ACTION_ID, "Failed to manage channel link: " + e.getMessage(), e);
        }
    }
    ...
    private Map<String, Object> performLinkOperation(String operation, String channelUID, String itemName,
            Map<String, Object> configParams, String autoUpdate) throws AIActionException {
        ...
        if (thingRegistry == null || itemRegistry == null || itemChannelLinkRegistry == null) {
            throw new AIActionException(ACTION_ID, "Required services not available", "SERVICE_UNAVAILABLE");
        }
        ...
        if (item == null) {
            throw new AIActionException(ACTION_ID, "Item not found: " + itemName, "RESOURCE_NOT_FOUND");
        }
    ...
    private Map<String, Object> createLink(ChannelUID channelUID, String itemName, Map<String, Object> configParams,
            String autoUpdate, Map<String, Object> result) throws AIActionException {
