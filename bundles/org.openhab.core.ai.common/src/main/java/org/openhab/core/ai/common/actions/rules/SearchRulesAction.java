...
/**
 * AIAction for searching openHAB Rules based on various criteria.
...
public class SearchRulesAction implements AIAction {
        ...
        try {
            ...
            if (limitObj != null) {
                ...
                if (limit < 1 || limit > 1000) {
                    return AIActionValidationResult.invalid(List.of("limit must be between 1 and 1000"));
                }
            }
            ...
            if (offsetObj != null) {
                ...
                if (offset < 0) {
                    return AIActionValidationResult.invalid(List.of("offset must be non-negative"));
                }
            }
            ...
            if (sortBy != null && !List.of("name", "uid", "type", "created").contains(sortBy)) {
                return AIActionValidationResult.invalid(List.of("Invalid sortBy value: " + sortBy));
            }

            // Validate sortOrder
            String sortOrder = (String) parameters.get("sortOrder");
            if (sortOrder != null && !List.of("asc", "desc").contains(sortOrder)) {
                return AIActionValidationResult.invalid(List.of("Invalid sortOrder value: " + sortOrder));
            }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to search rules: " + e.getMessage(), e);
        }
    }
