...
public interface AIJWTManager {
     ...
     */
    String generateToken(AIAuthenticationContext context);
     ...
     * @return JWT token string
     */
    String generateToken(AIAuthenticationContext context, Instant expiresAt);
     ...
     */
    Optional<AIAuthenticationContext> validateToken(String token);
