...
public class ThingChannelsAction implements AIAction {
    ...
    public AIActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (kindFilter != null && !kindFilter.isEmpty()) {
            ...
            if (!validKinds.contains(kindFilter.toUpperCase())) {
                return AIActionValidationResult.invalid(List.of("Invalid kindFilter. Must be one of: " + validKinds));
            }
        }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to get thing channels: " + e.getMessage(),
                    "EXECUTION_ERROR");
        }
    }
