...
public class GetPersistenceStatisticsAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            throw new AIActionException(ACTION_ID, "Failed to get persistence statistics: " + e.getMessage(), e);
        }
    }
    ...
    public AIActionMetadata getMetadata() {
        return AIActionMetadata.builder().author("openHAB")
                .description("Retrieves statistics from persistence services").version("1.0.0")
                .tags(List.of("persistence", "statistics", "metrics")).build();
    }
