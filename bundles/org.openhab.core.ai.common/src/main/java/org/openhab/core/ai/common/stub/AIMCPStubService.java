 ...
 * 
 */
public class AIMCPStubService implements AIStubService {

    private static final Logger logger = LoggerFactory.getLogger(AIMCPStubService.class);
    ...
    public AIStubResponse handleRequest(Object request) {
        ...
        return AIStubResponse.success("MCP request handled");
    }
