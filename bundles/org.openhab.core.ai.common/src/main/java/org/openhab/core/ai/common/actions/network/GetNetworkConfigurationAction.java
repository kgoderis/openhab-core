 ...
 */
@NonNullByDefault
public class GetNetworkConfigurationAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            throw new AIActionException(ACTION_ID, "Failed to get network configuration: " + e.getMessage(), e);
        }
    }
