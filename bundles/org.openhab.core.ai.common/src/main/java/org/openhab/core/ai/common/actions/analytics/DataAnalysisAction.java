package org.openhab.core.ai.common.actions.analytics;
...
/**
 * AIAction for data analysis including query, aggregation, visualization,
...
public class DataAnalysisAction implements AIAction {
    ...
    public AIActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (!validOperations.contains(operation)) {
            return AIActionValidationResult.invalid(List.of("Invalid operation. Must be one of: " + validOperations));
        }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            Map<String, Object> result = switch (operation) {
                ...
                default -> throw new AIActionException(ACTION_ID, "Unknown operation: " + operation);
            };
            ...
            throw new AIActionException(ACTION_ID, "Failed to execute data analysis operation: " + e.getMessage(), e);
        }
    }
