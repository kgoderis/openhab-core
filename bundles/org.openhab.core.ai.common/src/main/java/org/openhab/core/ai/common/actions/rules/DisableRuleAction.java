...
/**
 * AIAction for disabling openHAB Rules.
 * This action disables rules to prevent them from being executed.
 * 
 * 
 */
@Component(service = AIAction.class, immediate = true)
public class DisableRuleAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to disable rule: " + e.getMessage(), e);
        }
    }
