 ...
 */
@NonNullByDefault
public class VLLMClientImpl implements LLMClient {

    private final Logger logger = LoggerFactory.getLogger(VLLMClientImpl.class);
    ...
    public VLLMClientImpl(VLLMConfiguration config, @Nullable AIActionRegistry actionRegistry) {
        this.config = config;
        ...
        this.providerInfo = new LLMProviderInfo(LLMProviderType.VLLM, config.getModelName(), true, // supportsFunctionCalling
        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                return LLMResponse.builder().content(responseContent).modelName(config.getModelName())
                        .providerType(LLMProviderType.VLLM.name()).build();
