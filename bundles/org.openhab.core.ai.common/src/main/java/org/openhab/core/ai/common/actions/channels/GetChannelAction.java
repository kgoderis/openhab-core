...
public class GetChannelAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            throw new AIActionException(ACTION_ID, "Failed to get channel: " + e.getMessage(), e);
        }
    }
    ...
    public AIActionMetadata getMetadata() {
        return AIActionMetadata.builder().author("openHAB")
                .description("Retrieves detailed information about a specific channel").version("1.0.0")
                .tags(List.of("channels", "things", "automation")).build();
    }
