...
public class SetItemStateAction implements AIAction {
    ...
    public AIActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (state == null || state.trim().isEmpty()) {
            return AIActionValidationResult.invalid(List.of("State is required and cannot be empty"));
        }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            if (useCommand && newCommand != null) {
                ...
                throw new AIActionException(getActionId(), "Failed to parse state or command: " + stateValue);
            }
            ...
            throw new AIActionException(getActionId(), "Failed to set item state: " + e.getMessage(), e);
        }
    }
