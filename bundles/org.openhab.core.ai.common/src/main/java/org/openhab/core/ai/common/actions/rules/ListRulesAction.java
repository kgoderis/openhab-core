...
/**
 * AIAction for listing openHAB Rules with comprehensive filtering and metadata.
 * This action provides detailed rule information with filtering, sorting, and metadata options.
 * 
 * 
 */
@Component(service = AIAction.class, immediate = true)
public class ListRulesAction implements AIAction {
    ...
    public AIActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (limitObj != null) {
            try {
                ...
                if (limit < 1 || limit > 1000) {
                    return AIActionValidationResult.invalid(java.util.List.of("limit must be between 1 and 1000"));
                }
            } catch (NumberFormatException e) {
                return AIActionValidationResult.invalid(java.util.List.of("limit must be a valid integer"));
            }
        }
        ...
        if (offsetObj != null) {
            try {
                ...
                if (offset < 0) {
                    return AIActionValidationResult.invalid(java.util.List.of("offset must be non-negative"));
                }
            } catch (NumberFormatException e) {
                return AIActionValidationResult.invalid(java.util.List.of("offset must be a valid integer"));
            }
        }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to list rules: " + e.getMessage(), e);
        }
    }
    ...
    private Map<String, Object> listRules(String status, String tag, String type, boolean includeTriggers,
            ...
            String sortOrder, int limit, int offset) throws AIActionException {

        if (ruleRegistry == null) {
            throw new AIActionException(getActionId(), "RuleRegistry not available");
        }
