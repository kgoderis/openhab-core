...
/**
 * AIAction for retrieving detailed information about a specific openHAB Rule.
 * This action provides comprehensive rule details including triggers, conditions, actions, and configuration.
 * 
 * 
 */
@Component(service = AIAction.class, immediate = true)
public class GetRuleAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to get rule: " + e.getMessage(), e);
        }
    }
