 ...
 * 
 */
public class AIA2AStubService implements AIStubService {

    private static final Logger logger = LoggerFactory.getLogger(AIA2AStubService.class);
    ...
    public AIStubResponse handleRequest(Object request) {
        ...
        return AIStubResponse.success("A2A message handled");
    }
