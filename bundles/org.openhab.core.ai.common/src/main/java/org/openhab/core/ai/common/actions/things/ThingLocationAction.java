...
public class ThingLocationAction implements AIAction {
    ...
    public AIActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (!validSortBy.contains(sortBy)) {
            return AIActionValidationResult.invalid(List.of("Invalid sortBy. Must be one of: " + validSortBy));
        }
        ...
        if (!validSortOrder.contains(sortOrder)) {
            return AIActionValidationResult.invalid(List.of("Invalid sortOrder. Must be one of: " + validSortOrder));
        }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to get thing location information: " + e.getMessage(),
                    "EXECUTION_ERROR");
        }
    }
