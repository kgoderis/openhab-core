...
public class LLMHealthStatus {
    ...
    public LLMHealthStatus(boolean available, Instant lastCheckTime, long averageResponseTimeMs, double successRate,
    ...
    public String toString() {
        return "LLMHealthStatus{available=" + available + ", lastCheckTime=" + lastCheckTime
