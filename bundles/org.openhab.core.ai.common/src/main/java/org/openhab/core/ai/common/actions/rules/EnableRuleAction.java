...
/**
 * AIAction for enabling openHAB Rules.
 * This action enables rules to be executed when their triggers are activated.
 * 
 * 
 */
@Component(service = AIAction.class, immediate = true)
public class EnableRuleAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to enable rule: " + e.getMessage(), e);
        }
    }
    ...
    public AIActionMetadata getMetadata() {
        return AIActionMetadata.builder().version(getVersion()).author("openHAB").description(getDescription())
                .tags(java.util.List.of("rules", "enable", "automation")).build();
    }
