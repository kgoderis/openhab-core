...
/**
 * AIAction for performing comprehensive system health checks.
 * 
 * 
 */
@Component(service = AIAction.class, immediate = true)
public class HealthCheckAction implements AIAction {
    ...
    public AIActionValidationResult validateParameters(Map<String, Object> parameters) {
        if (parameters == null) {
            return AIActionValidationResult.valid(parameters); // No parameters required
        }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            return AIActionResult.success(healthReport, executionTime);

        } catch (Exception e) {
            long executionTime = System.currentTimeMillis() - startTime;
            logger.error("Failed to perform health checks", e);
            throw new AIActionException(ACTION_ID, "Failed to perform health checks: " + e.getMessage(), e);
        }
    }
