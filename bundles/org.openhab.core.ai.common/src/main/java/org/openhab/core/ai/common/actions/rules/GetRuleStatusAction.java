...
/**
 * AIAction for retrieving detailed status information about openHAB Rules.
 * This action provides comprehensive rule status including execution state, errors, and performance metrics.
 * 
 * 
 */
@Component(service = AIAction.class, immediate = true)
public class GetRuleStatusAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to get rule status: " + e.getMessage(), e);
        }
    }
