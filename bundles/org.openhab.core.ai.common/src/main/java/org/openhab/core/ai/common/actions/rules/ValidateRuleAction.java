...
public class ValidateRuleAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to validate rule: " + e.getMessage(), e);
        }
    }
