...
public class ListChannelsAction implements AIAction {
    ...
    public AIActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (Boolean.TRUE.equals(linkedOnly) && Boolean.TRUE.equals(unlinkedOnly)) {
            return AIActionValidationResult.invalid(List.of("linkedOnly and unlinkedOnly cannot both be true"));
        }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            long executionTime = System.currentTimeMillis() - startTime;
            throw new AIActionException(ACTION_ID, "Failed to list Channels: " + e.getMessage(), e);
        }
    }
    ...
    private Map<String, Object> listChannels(String thingUID, String channelType, String acceptedItemType, String kind,
            ...
            int offset) throws AIActionException {

        Map<String, Object> result = new HashMap<>();
        result.put("timestamp", Instant.now().toString());

        if (thingRegistry == null) {
            throw new AIActionException(ACTION_ID, "ThingRegistry service not available", "SERVICE_UNAVAILABLE");
        }
