...
public class SetItemTagsAction implements AIAction {
    ...
    public AIActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (tagsObj == null || !(tagsObj instanceof Map)) {
            return AIActionValidationResult.invalid(List.of("Tags must be an object"));
        }

        @SuppressWarnings("unchecked")
        Map<String, Object> tags = (Map<String, Object>) tagsObj;
        if (tags.isEmpty()) {
            return AIActionValidationResult.invalid(List.of("Tags object cannot be empty"));
        }
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            throw new AIActionException(getActionId(), "Failed to set item tags: " + e.getMessage(), e);
        }
    }
    ...
    public AIActionMetadata getMetadata() {
        return AIActionMetadata.builder().version(getVersion()).author("openHAB")
                .description("Set or update tag information for openHAB items")
                .tags(List.of("items", "tags", "metadata", "write"))
                .documentation(
