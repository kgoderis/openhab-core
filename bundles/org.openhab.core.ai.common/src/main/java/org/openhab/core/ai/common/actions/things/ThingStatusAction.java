...
public class ThingStatusAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            long executionTime = System.currentTimeMillis() - startTime;
            throw new AIActionException(ACTION_ID, "Failed to manage Thing status: " + e.getMessage(), e);
        }
    }
    ...
    public AIActionMetadata getMetadata() {
        return AIActionMetadata.builder().description(DESCRIPTION).version(VERSION).author("openHAB")
                .tags(List.of("things", "status", "management")).build();
    }
    ...
    private Map<String, Object> performStatusAction(String thingUID, String action, boolean includeStatusHistory,
            boolean includeDetails) throws AIActionException {
        ...
        if (!thingExists(thingUID)) {
            throw new AIActionException(ACTION_ID, "Thing not found: " + thingUID, "RESOURCE_NOT_FOUND");
        }
