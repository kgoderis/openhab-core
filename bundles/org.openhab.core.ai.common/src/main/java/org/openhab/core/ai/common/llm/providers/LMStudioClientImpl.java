 ...
 */
@NonNullByDefault
public class LMStudioClientImpl implements LLMClient {

    private final Logger logger = LoggerFactory.getLogger(LMStudioClientImpl.class);
    ...
    public LMStudioClientImpl(LMStudioConfiguration config, @Nullable AIActionRegistry actionRegistry) {
        this.config = config;
        ...
        this.providerInfo = new LLMProviderInfo(LLMProviderType.LMSTUDIO, config.getModelName(), true, // supportsFunctionCalling
        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                return LLMResponse.builder().content(responseContent).modelName(config.getModelName())
                        .providerType(LLMProviderType.LMSTUDIO.name()).build();
