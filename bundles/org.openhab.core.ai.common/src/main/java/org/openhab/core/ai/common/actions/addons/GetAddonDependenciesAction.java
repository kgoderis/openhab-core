...
public class GetAddonDependenciesAction implements AIAction {
    ...
    public AIActionResult execute(Map<String, Object> parameters, AIActionContext context) throws AIActionException {
        ...
        try {
            ...
            long executionTime = System.currentTimeMillis() - startTime;
            throw new AIActionException(ACTION_ID, "Failed to execute dependency analysis operation: " + e.getMessage(),
                    e);
        }
    }
