...
import org.openhab.core.ai.common.api.reasoning.MultiStepReasoningConfiguration;
import org.openhab.core.ai.common.api.reasoning.MultiStepReasoningResult;
import org.openhab.core.ai.common.api.reasoning.ReasoningContext;
...
public class MultiStepReasoningEngineTest {
    ...
    void testReasonAsyncWithValidContext() throws ExecutionException, InterruptedException {
        ...
        LLMResponse mockResponse = createMockLLMResponse("Step 1 reasoning: Analyzing the situation...");

        when(llmClient.complete(anyString(), any(LLMParameters.class)))
        ...
        verify(llmClient, atLeastOnce()).complete(anyString(), any(LLMParameters.class));
    }
    ...
    void testMultiStepReasoningWithContextAccumulation() throws ExecutionException, InterruptedException {
        // Given
        ReasoningContext context = new ReasoningContext("Initial context", "Current context");
        LLMResponse step1Response = createMockLLMResponse("Step 1: Understanding the problem...");
        LLMResponse step2Response = createMockLLMResponse("Step 2: Based on previous analysis, I can see...");
        ...
        verify(llmClient, atLeast(2)).complete(anyString(), any(LLMParameters.class));

        // Check that the second call includes context from the first step
        verify(llmClient).complete(argThat(prompt -> prompt.contains("Step 1")), any(LLMParameters.class));
    }
    ...
    void testReasoningWithGuidancePrompts() throws ExecutionException, InterruptedException {
        ...
        LLMResponse mockResponse = createMockLLMResponse("Following guidance for step 1...");
    ...
    void testStepLimitEnforcement() throws ExecutionException, InterruptedException {
        // Given
        ReasoningContext context = new ReasoningContext("Initial context", "Current context");
        LLMResponse mockResponse = createMockLLMResponse("Continuing reasoning...");
        ...
        verify(llmClient, atMost(5)).complete(anyString(), any(LLMParameters.class));
    }
    ...
    void testReasoningCompletionDetection() throws ExecutionException, InterruptedException {
        // Given
        ReasoningContext context = new ReasoningContext("Initial context", "Current context");
        LLMResponse completionResponse = createMockLLMResponse(
        ...
        verify(llmClient, times(1)).complete(anyString(), any(LLMParameters.class));
    }
    ...
    void testConfidenceThresholdCompletion() throws ExecutionException, InterruptedException {
        // Given
        ReasoningContext context = new ReasoningContext("Initial context", "Current context");
        LLMResponse highConfidenceResponse = createMockLLMResponse("I am very confident about this because...");
        ...
        verify(llmClient, atMost(2)).complete(anyString(), any(LLMParameters.class));
    }
    ...
    void testErrorHandlingAndRecovery() throws ExecutionException, InterruptedException {
        ...
        when(llmClient.complete(anyString(), any(LLMParameters.class)))
                ...
                .thenReturn(CompletableFuture.completedFuture(createMockLLMResponse("Recovered reasoning...")));
    ...
    void testPerformanceMonitoring() throws ExecutionException, InterruptedException {
        // Given
        ReasoningContext context = new ReasoningContext("Initial context", "Current context");
        LLMResponse mockResponse = createMockLLMResponse("Performance test reasoning...");
    ...
    void testActionIntegration() throws ExecutionException, InterruptedException {
        // Given
        ReasoningContext context = new ReasoningContext("Initial context", "Current context");
        LLMResponse mockResponse = createMockLLMResponse("I need to call an action to get more information...");
    ...
    void testSessionTimeoutHandling() throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<LLMResponse> slowResponse = new CompletableFuture<>();
        when(llmClient.complete(anyString(), any(LLMParameters.class))).thenReturn(slowResponse);
    ...
    void testEmptyContextHandling() throws ExecutionException, InterruptedException {
        ...
        LLMResponse mockResponse = createMockLLMResponse("Reasoning with empty context...");
    ...
    void testConcurrentReasoningSessions() throws ExecutionException, InterruptedException {
        ...
        LLMResponse mockResponse = createMockLLMResponse("Concurrent reasoning...");
