...
/**
 * Integration tests for Config-related AIActions using mocked openHAB services.
 */
class ConfigActionIntegrationTest extends BaseAIActionIntegrationTest {
    ...
    void testConfigurationGetAction() throws Exception {
        ...
        AIActionResult result = executeAction(configurationGetAction, parameters);
    ...
    void testConfigurationSetAction() throws Exception {
        ...
        AIActionResult result = executeAction(configurationSetAction, parameters);
    ...
    void testConfigurationListAction() throws Exception {
        ...
        AIActionResult result = executeAction(configurationListAction, parameters);
    ...
    void testConfigurationValidationAction() throws Exception {
        ...
        AIActionResult result = executeAction(configurationValidationAction, parameters);
    ...
    void testConfigurationImportAction() throws Exception {
        ...
        AIActionResult result = executeAction(configurationImportAction, parameters);
    ...
    void testConfigurationExportAction() throws Exception {
        ...
        AIActionResult result = executeAction(configurationExportAction, parameters);
    ...
    void testConfigurationBackupAction() throws Exception {
        ...
        AIActionResult result = executeAction(configurationBackupAction, parameters);
