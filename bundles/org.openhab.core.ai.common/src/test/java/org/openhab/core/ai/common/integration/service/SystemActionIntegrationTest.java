...
/**
 * Integration tests for System-related AIActions using mocked openHAB services.
 */
class SystemActionIntegrationTest extends BaseAIActionIntegrationTest {
    ...
    void testSystemInfoAction() throws Exception {
        ...
        AIActionResult result = executeAction(systemInfoAction, parameters);
    ...
    void testSystemStatusAction() throws Exception {
        Map<String, Object> parameters = Map.of("filter", "all");
        AIActionResult result = executeAction(systemStatusAction, parameters);
    ...
    void testSystemDiagnosticsAction() throws Exception {
        ...
        AIActionResult result = executeAction(systemDiagnosticsAction, parameters);
    ...
    void testHealthCheckAction() throws Exception {
        Map<String, Object> parameters = Map.of("filter", "all");
        AIActionResult result = executeAction(healthCheckAction, parameters);
    ...
    void testCPUInfoAction() throws Exception {
        Map<String, Object> parameters = Map.of("filter", "all");
        AIActionResult result = executeAction(cpuInfoAction, parameters);
    ...
    void testMemoryInfoAction() throws Exception {
        Map<String, Object> parameters = Map.of("filter", "all");
        AIActionResult result = executeAction(memoryInfoAction, parameters);
    ...
    void testDiskInfoAction() throws Exception {
        Map<String, Object> parameters = Map.of("filter", "all");
        AIActionResult result = executeAction(diskInfoAction, parameters);
