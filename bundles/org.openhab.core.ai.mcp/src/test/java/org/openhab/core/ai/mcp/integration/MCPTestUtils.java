...
public class MCPTestUtils {
    ...
    public static Map<String, Object> createTestItemsData() {
        return Map.of("items",
                java.util.List.of(Map.of("name", "TestSwitch", "type", "Switch", "state", "OFF"),
    ...
    public static Map<String, Object> createTestThingsData() {
        return Map.of("things",
                java.util.List.of(Map.of("uid", "test:thing:1", "label", "Test Thing 1", "status", "ONLINE"),
    ...
    public static Map<String, Object> createTestPersistenceData() {
        return Map.of("status", "RUNNING", "services", java.util.List.of("rrd4j", "mapdb"), "backup",
                Map.of("lastBackup", "2024-01-01T00:00:00Z", "size", "1024KB"));
    }
}
