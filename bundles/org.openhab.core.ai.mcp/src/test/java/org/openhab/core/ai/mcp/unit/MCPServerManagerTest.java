...
class MCPServerManagerTest {
    ...
    void testRemoveServerInstance() {
        ...
        assertDoesNotThrow(() -> {
            ...
            MCPServerConfiguration config = MCPServerConfiguration.builder().serverId("remove-test")
    ...
    void testCreateServerInstanceWithNullId() {
        ...
        assertDoesNotThrow(() -> {
            ...
            MCPServerConfiguration config = MCPServerConfiguration.builder().serverId("test").build();
    ...
    void testGracefulShutdown() {
        ...
        assertDoesNotThrow(() -> {
            ...
            MCPServerConfiguration config1 = MCPServerConfiguration.builder().serverId("server1").serverName("Server 1")
                    .build();

            MCPServerConfiguration config2 = MCPServerConfiguration.builder().serverId("server2").serverName("Server 2")
                    .build();
    ...
    void testServerInstanceLifecycle() {
        ...
        assertDoesNotThrow(() -> {
            ...
            // Create a server instance
            MCPServerConfiguration config = MCPServerConfiguration.builder().serverId("lifecycle-test")
