package org.openhab.core.ai.mcp.tools.karaf;
...
public class KarafManagementTool implements MCPTool {
    ...
    public MCPToolValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (operation == null) {
            return MCPToolValidationResult.invalid("Missing required parameter: operation");
        }
        ...
        if (List.of("bundle_info", "start_bundle", "stop_bundle", "restart_bundle", "refresh_bundle", "set_start_level",
            ...
            if (bundleId == null || bundleId.trim().isEmpty()) {
                return MCPToolValidationResult.invalid("bundleId is required for operation: " + operation);
            }
        }
        ...
        if ("set_start_level".equals(operation)) {
            ...
            if (startLevel == null || startLevel < 1) {
                return MCPToolValidationResult.invalid("Valid startLevel (>= 1) is required for set_start_level");
            }
        }
    ...
    public MCPToolResult execute(Map<String, Object> parameters, MCPToolContext context) throws MCPToolException {
        ...
        if (bundleContext == null) {
            throw new MCPToolException(TOOL_ID, "Bundle context not available",
                    MCPToolException.MCPToolErrorCode.EXECUTION_ERROR);
        }
        ...
        try {
            ...
            Map<String, Object> result = switch (operation) {
                ...
                default -> throw new MCPToolException(TOOL_ID, "Unknown operation: " + operation,
                        MCPToolException.MCPToolErrorCode.INVALID_PARAMETER);
            };

            long executionTime = System.currentTimeMillis() - startTime;
            return MCPToolResult.successJson(TOOL_ID, result, executionTime);

        } catch (Exception e) {
            long executionTime = System.currentTimeMillis() - startTime;
            throw new MCPToolException(TOOL_ID, "Karaf management operation failed: " + e.getMessage(), e,
                    MCPToolException.MCPToolErrorCode.EXECUTION_ERROR);
        }
    }
