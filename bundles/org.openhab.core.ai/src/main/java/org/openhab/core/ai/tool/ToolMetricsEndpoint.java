...
public class ToolMetricsEndpoint {
    ...
    public ToolMetricsEndpoint(ToolServer serverInstance, ToolServerConfiguration config) throws IOException {
        ...
        public void handle(com.sun.net.httpserver.@Nullable HttpExchange exchange) throws IOException {
            try {
                ...
                if (serverInstance.isSecurityEnabled()) {
                    ToolSecurityManager.SecurityStatistics securityStats = serverInstance.getSecurityStatistics();
