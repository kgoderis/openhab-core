...
public class ConfigurationPerformanceMetrics {
    ...
    public long getTotalPolicyUpdates() { return totalPolicyUpdates; }
    public long getTotalPreferenceUpdates() { return totalPreferenceUpdates; }
    public long getTotalConstraintUpdates() { return totalConstraintUpdates; }
    public int getAgentConfigurationCount() { return agentConfigurationCount; }
    public int getBehaviorPolicyCount() { return behaviorPolicyCount; }
    public int getUserPreferenceCount() { return userPreferenceCount; }
    public int getConstraintDefinitionCount() { return constraintDefinitionCount; }
    public int getSafetyPolicyCount() { return safetyPolicyCount; }

    public static ConfigurationPerformanceMetricsBuilder builder() { return new ConfigurationPerformanceMetricsBuilder(); }
}
