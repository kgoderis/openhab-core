...
public class AutonomousPerformanceMetrics {
    ...
    public long getTotalAutonomousActions() { return totalAutonomousActions; }
    public long getTotalPatternDetections() { return totalPatternDetections; }
    public long getTotalSafetyViolations() { return totalSafetyViolations; }
    public long getTotalUserOverrides() { return totalUserOverrides; }
    public int getPendingActionCount() { return pendingActionCount; }
    ...
    public static AutonomousPerformanceMetricsBuilder builder() { return new AutonomousPerformanceMetricsBuilder(); }
