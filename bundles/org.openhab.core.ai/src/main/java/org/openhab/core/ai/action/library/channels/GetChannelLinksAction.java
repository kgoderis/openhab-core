 ...
 */
@NonNullByDefault
public class GetChannelLinksAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ActionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(ACTION_ID, "Failed to get channel links: " + e.getMessage(), e);
        }
    }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().author("openHAB").description("Retrieves information about item-channel links")
                .version("1.0.0").tags(List.of("channels", "links", "items")).build();
    }
