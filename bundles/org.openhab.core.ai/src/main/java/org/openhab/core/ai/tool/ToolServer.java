...
public class ToolServer {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ToolServer.class);
    ...
    private volatile @Nullable ToolTransportType currentTransportType;
    ...
    private volatile @Nullable ToolErrorRecoveryManager errorRecoveryManager;
     ...
     */
    public ToolServer(String serverId, ToolServerConfiguration configuration, ToolRegistry toolRegistry) {
     ...
     */
    public void setSecurityManager(ToolSecurityManager securityManager) {
     ...
     */
    public void setErrorRecoveryManager(ToolErrorRecoveryManager errorRecoveryManager) {
     ...
     */
    public ToolSecurityManager.@Nullable SecurityStatistics getSecurityStatistics() {
        ToolSecurityManager manager = securityManager;
     ...
     */
    public ToolErrorRecoveryManager.@Nullable ErrorRecoveryStatistics getErrorRecoveryStatistics() {
        ToolErrorRecoveryManager manager = errorRecoveryManager;
     ...
     */
    public java.util.@Nullable Map<String, ToolErrorRecoveryManager.ErrorInfo> getErrorDetails() {
        ToolErrorRecoveryManager manager = errorRecoveryManager;
    ...
    public static class TransportHealthInfo {
        private final @Nullable ToolTransportType transportType;
        private final boolean healthy;
        private final long startTime;
        private final @Nullable String lastError;
        private final long uptime;

        public TransportHealthInfo(@Nullable ToolTransportType transportType, boolean healthy, long startTime,
        ...
        public @Nullable ToolTransportType getTransportType() {
    ...
    public static class TransportStatistics {
        private final @Nullable ToolTransportType currentType;
        private final long startTime;
        private final long uptime;
        private final boolean healthy;
        private final @Nullable String lastError;
        private final String transportClass;
        private final ToolTransportType configuredType;

        public TransportStatistics(@Nullable ToolTransportType currentType, long startTime, long uptime,
                boolean healthy, @Nullable String lastError, String transportClass, ToolTransportType configuredType) {
        ...
        public @Nullable ToolTransportType getCurrentType() {
            return currentType;
        }
        ...
        public ToolTransportType getConfiguredType() {
    ...
    private void initializeMCPServer() throws Exception {
        ...
        ToolTransportType transportType = configuration.getTransportType();
        ...
        // Validate transport
        validateTransport(mcpTransport, transportType);
    ...
    private void validateTransportConfiguration(ToolTransportType transportType) {
    ...
    private void validateTransport(McpServerTransportProvider transport, ToolTransportType transportType) {
        if (transport == null) {
