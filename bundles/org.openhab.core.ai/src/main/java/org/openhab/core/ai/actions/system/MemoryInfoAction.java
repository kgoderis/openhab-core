...
/**
 * Action for retrieving detailed memory information including heap, non-heap, and memory pool details.
 * 
 * This action provides comprehensive memory diagnostics using real Java Management APIs.
 */
@Component(service = Action.class, immediate = true)
public class MemoryInfoAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ActionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(ACTION_ID, "Failed to collect memory information: " + e.getMessage(), e);
        }
    }
