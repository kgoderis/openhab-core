package org.openhab.core.ai.actions.system;
...
/**
 * Action for retrieving real-time openHAB system status.
 * 
 * 
 */
@Component(service = Action.class, immediate = true)
public class SystemStatusAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ActionContext context) throws ActionException {
        ...
        try {
            ...
            return ActionResult.success(status, executionTime);

        } catch (Exception e) {
            long executionTime = System.currentTimeMillis() - startTime;
            logger.error("Failed to collect system status", e);
            throw new ActionException(ACTION_ID, "Failed to collect system status: " + e.getMessage(), e);
        }
    }
