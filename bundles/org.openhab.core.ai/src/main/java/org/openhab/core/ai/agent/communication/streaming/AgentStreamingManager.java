package org.openhab.core.ai.agent.communication.streaming;
 ...
 * @since 1.0.0
 */
@Component(service = AgentStreamingManager.class)
public class AgentStreamingManager {

    private static final Logger logger = LoggerFactory.getLogger(AgentStreamingManager.class);
    ...
    public Flow.Publisher<StreamingEventKind> handleStreamingMessageSend(MessageSendParams params) throws JSONRPCError {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                ActionResult result = executeActionWithStreaming(actionId, parameters, task.getId(), publisher);
    ...
    private ActionResult executeActionWithStreaming(String actionId, Map<String, Object> parameters, String taskId,
