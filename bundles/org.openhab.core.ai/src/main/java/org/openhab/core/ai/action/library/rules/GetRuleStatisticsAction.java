...
/**
 * Action for retrieving statistical information about openHAB Rules.
...
public class GetRuleStatisticsAction implements Action {
    ...
    public ActionValidationResult validateParameters(Map<String, Object> parameters) {
        try {
            ...
            if (timeRange != null && !List.of("1h", "24h", "7d", "30d", "all").contains(timeRange)) {
                return ActionValidationResult.invalid(List.of("Invalid timeRange: " + timeRange));
            }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withVersion(getVersion()).withAuthor("openHAB")
                .withDescription(getDescription()).withTags(List.of("rules", "statistics", "monitoring")).build();
    }
