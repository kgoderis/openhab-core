...
import org.openhab.core.ai.reasoning.context.ContextOptimizationResult;
import org.openhab.core.ai.reasoning.context.ContextOptimizationRule;
...
public class AgentModelContextValidator {
     ...
     * @param result The validation result to update
     */
    private void applyCustomValidationRules(AgentModelContext context, ContextValidationResult result) {
     ...
     */
    private void optimizeDataStructure(AgentModelContext context, ContextOptimizationResult result) {
     ...
     * @param result The optimization result to update
     */
    private void optimizeMetadata(AgentModelContext context, ContextOptimizationResult result) {
     ...
     * @param result The optimization result to update
     */
    private void applyCustomOptimizationRules(AgentModelContext context, ContextOptimizationResult result) {
