 ...
 * 
 */
public class RuleStubService implements StubService {

    private static final Logger logger = LoggerFactory.getLogger(RuleStubService.class);
    ...
    public StubResponse handleRequest(Object request) {
        ...
        return StubResponse.success("Rule operation handled");
    }
