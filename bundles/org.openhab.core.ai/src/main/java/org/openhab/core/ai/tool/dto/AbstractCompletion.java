...
public abstract class AbstractCompletion {
    ...
    protected static final Logger LOGGER = LoggerFactory.getLogger(AbstractCompletion.class);
     ...
     */
    protected AbstractCompletion(String promptReference, String description, List<String> suggestions, int total,
    ...
    public String toString() {
        return "AbstractCompletion{promptReference='" + promptReference + "', description='" + description
