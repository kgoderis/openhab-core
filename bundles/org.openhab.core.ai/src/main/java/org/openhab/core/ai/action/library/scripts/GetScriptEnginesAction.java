...
/**
 * Action for retrieving available Script Engines and their capabilities.
 * 
...
public class GetScriptEnginesAction implements Action {
    ...
    public ActionValidationResult validateParameters(Map<String, Object> parameters) {
        if (parameters == null) {
            return ActionValidationResult.valid(new HashMap<>());
        }
        ...
        if (filterLanguage != null && filterLanguage.trim().isEmpty()) {
            return ActionValidationResult.invalid(List.of("filterByLanguage cannot be empty if provided"));
        }
    ...
    public ActionResult execute(Map<String, Object> parameters, ExecutionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(ACTION_ID, "Failed to get script engines: " + e.getMessage(), e);
        }
    }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withVersion(getVersion())
                .withDescription("Retrieves available script engines and their capabilities").build();
    }
