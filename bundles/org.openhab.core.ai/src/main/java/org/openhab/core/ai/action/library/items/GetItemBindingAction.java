...
public class GetItemBindingAction implements Action {
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withVersion(getVersion()).withAuthor("openHAB")
                .withDescription("Retrieve binding information for openHAB items")
                .withTags(List.of("items", "bindings", "things", "channels", "status"))
                .withDocumentation(
                        "Retrieves binding information for openHAB items including thing details, channel information, and binding status.")
                .withExamples(List.of("Get basic binding info: {\"itemName\": \"LivingRoom_Light\"}",
