...
/**
 * Action for retrieving comprehensive openHAB system information.
 * 
 * 
 */
...
public class SystemInfoAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ActionContext context) throws ActionException {
        ...
        try {
            ...
            return ActionResult.success(systemInfo, executionTime);

        } catch (Exception e) {
            long executionTime = System.currentTimeMillis() - startTime;
            logger.error("Failed to collect system information", e);
            throw new ActionException(ACTION_ID, "Failed to collect system information: " + e.getMessage(), e);
        }
    }
