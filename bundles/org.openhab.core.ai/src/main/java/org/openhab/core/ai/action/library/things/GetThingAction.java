...
public class GetThingAction implements Action {
    ...
    public ActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (thingUID == null || thingUID.trim().isEmpty()) {
            return ActionValidationResult.invalid(List.of("Thing UID is required and cannot be empty"));
        }
        ...
        try {
            ...
            return ActionValidationResult.invalid(List.of("Invalid thing UID format: " + thingUID));
        } catch (Exception e) {
    ...
    public ActionResult execute(Map<String, Object> parameters, ExecutionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(getActionId(), "Failed to get thing information: " + e.getMessage(), e);
        }
    }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withVersion(getVersion()).withAuthor("openHAB")
                .withDescription("Retrieve comprehensive information about a single openHAB thing")
                .withTags(List.of("things", "information", "details", "comprehensive"))
                .withDocumentation(
                ...
                .withExamples(List.of("Get basic info: {\"thingUID\": \"binding:type:thing\"}",
