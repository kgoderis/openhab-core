...
public class StartDiscoveryAction implements Action {
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withAuthor("openHAB")
                .withDescription("Starts device discovery processes for various protocols and device types")
                .withVersion("1.0.0").withTags(List.of("discovery", "devices", "network", "scanning")).build();
    }
