...
public class AgentRestResource implements RESTResource {
    ...
    static final class AgentCardSummary {
        private final List<String> agentIds;
        private final TransportSummary transports;

        AgentCardSummary(List<String> agentIds, TransportSummary transports) {
    ...
    static final class TransportSummary {
        private final int totalActive;
        private final int restActive;

        TransportSummary(int totalActive, int restActive) {
