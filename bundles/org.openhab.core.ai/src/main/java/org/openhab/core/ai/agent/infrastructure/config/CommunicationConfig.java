...
public class CommunicationConfig {
    ...
    public MessagingConfig getMessagingConfig() { return messagingConfig; }
    public void setMessagingConfig(MessagingConfig messagingConfig) { this.messagingConfig = messagingConfig; }
