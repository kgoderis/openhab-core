 ...
 * 
 */
public class EventStubService implements StubService {

    private static final Logger logger = LoggerFactory.getLogger(EventStubService.class);
    ...
    public StubResponse handleRequest(Object request) {
        ...
        return StubResponse.success("Event operation handled");
    }
