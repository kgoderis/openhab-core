    ...
    public ActionResult execute(Map<String, Object> parameters, ActionContext context) throws ActionException {
        ...
        try {
            ...
            if (!Files.isRegularFile(filePath)) {
                throw new ActionException(ACTION_ID, "Path is not a regular file: " + path);
            }

            // Check file size
            long fileSize = Files.size(filePath);
            if (fileSize > maxSize) {
                throw new ActionException(ACTION_ID, String
            ...
            throw new ActionException(ACTION_ID, "Failed to read file: " + errorMessage);
        } catch (Exception e) {
