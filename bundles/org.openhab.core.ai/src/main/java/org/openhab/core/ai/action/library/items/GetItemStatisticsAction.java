...
public class GetItemStatisticsAction implements Action {
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withVersion(getVersion()).withAuthor("openHAB")
                .withDescription("Retrieve statistical information about openHAB items")
                .withTags(List.of("items", "statistics", "analytics", "metrics"))
                .withDocumentation(
                ...
                .withExamples(List.of("Get basic statistics: {\"itemName\": \"LivingRoom_Light\"}",
