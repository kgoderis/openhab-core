 ...
 */
@NonNullByDefault
public class ModelRateLimitInfo {
    ...
    public ModelRateLimitInfo(int remainingRequests, int totalRequests, Instant resetTime, String window) {
    ...
    public String toString() {
        return "ModelRateLimitInfo{remainingRequests=" + remainingRequests + ", totalRequests=" + totalRequests
