...
public class AgentGrpcTransport implements AgentTransport {
     ...
     */
    private static class GrpcTransportCapabilities implements TransportCapabilities {
    ...
    /**
     * gRPC Transport Health Implementation.
     */
    private static class GrpcTransportHealth implements TransportHealth {
