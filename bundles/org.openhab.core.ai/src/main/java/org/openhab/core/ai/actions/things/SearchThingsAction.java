...
public class SearchThingsAction implements Action {
    ...
    public ActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (status != null && !status.trim().isEmpty()) {
            try {
                ...
                return ActionValidationResult.invalid(List.of("Invalid status: " + status));
            }
        }
        ...
        if (maxResultsObj != null) {
            if (maxResultsObj instanceof Number) {
                ...
                if (maxResults <= 0) {
                    return ActionValidationResult.invalid(List.of("maxResults must be positive"));
                }
            } else {
                return ActionValidationResult.invalid(List.of("maxResults must be a number"));
            }
        }
    ...
    public ActionResult execute(Map<String, Object> parameters, ActionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(getActionId(), "Failed to search things: " + e.getMessage(), e);
        }
    }
