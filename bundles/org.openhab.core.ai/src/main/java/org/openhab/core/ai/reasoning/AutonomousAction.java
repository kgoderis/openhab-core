...
public class AutonomousAction {
    ...
    public @Nullable String getOverrideReason() { return overrideReason; }
    public void setOverrideReason(@Nullable String overrideReason) { this.overrideReason = overrideReason; }

    public @Nullable Instant getOverrideTimestamp() { return overrideTimestamp; }
    public void setOverrideTimestamp(@Nullable Instant overrideTimestamp) { this.overrideTimestamp = overrideTimestamp; }
}
