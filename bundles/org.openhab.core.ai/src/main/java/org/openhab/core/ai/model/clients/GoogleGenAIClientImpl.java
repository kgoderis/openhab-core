 ...
 */
@NonNullByDefault
public class GoogleGenAIClientImpl implements ModelClient {
    ...
    public GoogleGenAIClientImpl(GoogleGenAIConfiguration config, @Nullable ActionRegistry actionRegistry) {
        this.config = config;
