 ...
 */
@NonNullByDefault
public class AnthropicClientImpl implements ModelClient {
    ...
    public AnthropicClientImpl(AnthropicConfiguration config, @Nullable ActionRegistry actionRegistry) {
        this.config = config;
