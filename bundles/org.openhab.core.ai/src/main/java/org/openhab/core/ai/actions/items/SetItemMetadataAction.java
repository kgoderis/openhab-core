...
@NonNullByDefault
public class SetItemMetadataAction implements Action {
    ...
    public ActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (namespace == null || namespace.trim().isEmpty()) {
            return ActionValidationResult.invalid(List.of("Namespace is required and cannot be empty"));
        }

        String value = (String) parameters.get("value");
        if (value == null) {
            return ActionValidationResult.invalid(List.of("Value is required"));
        }
        ...
        if (configuration != null && !(configuration instanceof Map)) {
            return ActionValidationResult.invalid(List.of("Configuration must be an object"));
        }
    ...
    public ActionResult execute(Map<String, Object> parameters, ActionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(getActionId(), "Failed to set item metadata: " + e.getMessage(), e);
        }
    }
