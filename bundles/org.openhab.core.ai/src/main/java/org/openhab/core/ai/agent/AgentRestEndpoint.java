...
public class AgentRestEndpoint {
    ...
    public void initialize() {
        ...
        if (!readyService.isReady(AgentProtocolHandler.AGENT_SERVER_READY)) {
        ...
        try {
            ...
            protocolHandler = bundleContext.getService(bundleContext.getServiceReference(AgentProtocolHandler.class));
            if (protocolHandler == null) {
