 ...
 */
@NonNullByDefault
public class StopDiscoveryAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ExecutionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(ACTION_ID, "Failed to stop discovery: " + e.getMessage(), e);
        }
    }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withAuthor("openHAB")
                .withDescription("Stops ongoing device discovery processes").withVersion("1.0.0")
                .withTags(List.of("discovery", "stop", "control", "management")).build();
    }
