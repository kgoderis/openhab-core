 ...
 */
@NonNullByDefault
public record FilterStatistics(List<AgentTaskSnapshot> snapshots, Duration timeRange, long timestampMs)
        implements
            StatisticsSnapshot,
            CountsMetrics,
            LatencyMetrics,
     ...
     */
    public static FilterStatistics fromSnapshots(List<AgentTaskSnapshot> snapshots, Duration timeRange) {
        return new FilterStatistics(snapshots, timeRange, System.currentTimeMillis());
    }
     ...
     */
    public static FilterStatistics empty(Duration timeRange) {
        return new FilterStatistics(List.of(), timeRange, System.currentTimeMillis());
    }
}
