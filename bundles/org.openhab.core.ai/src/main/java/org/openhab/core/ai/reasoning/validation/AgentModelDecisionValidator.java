...
import org.openhab.core.ai.reasoning.decision.DecisionValidationResult;
import org.openhab.core.ai.reasoning.enums.RiskLevel;
import org.openhab.core.ai.reasoning.results.DecisionResult;
import org.openhab.core.ai.reasoning.results.RiskAssessmentResult;
...
public class AgentModelDecisionValidator {
    ...
    private void validateConfidence(DecisionResult decision, DecisionContext context, DecisionValidationResult result) {
        ...
        if (context.getRiskLevel() == RiskLevel.HIGH && confidence < HIGH_RISK_CONFIDENCE_THRESHOLD) {
     ...
     * @param result The validation result to update
     */
    private void validateCompliance(DecisionResult decision, DecisionContext context, DecisionValidationResult result) {
     ...
     */
    // ValidationRule extracted to org.openhab.core.ai.reasoning.ValidationRule
}
