 ...
 * @since 1.0.0
 */
@Component(service = ToolResourceManager.class)
@NonNullByDefault
public class ToolResourceManager {

    private static final Logger logger = LoggerFactory.getLogger(ToolResourceManager.class);
