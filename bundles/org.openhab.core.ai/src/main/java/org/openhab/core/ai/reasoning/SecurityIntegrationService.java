    ...
    public CompletableFuture<ComprehensiveSecurityResult> validateSecurity(
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                SecurityValidationResult authResult = agentModelSecurityManager.validateSecurity(request, context).get();
                ...
                SafetyValidationResult safetyResult = safetyConstraintManager
