...
public class ToolServer {
    ...
    private volatile @Nullable SecurityManager securityManager;
     ...
     */
    public ToolServer(String serverId, ServerConfiguration configuration, ToolRegistry toolRegistry) {
     ...
     */
    public SecurityManager.@Nullable SecurityStatistics getSecurityStatistics() {
