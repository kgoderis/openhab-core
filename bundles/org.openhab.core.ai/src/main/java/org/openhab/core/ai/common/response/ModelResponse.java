...
public class ModelResponse implements Response<String> {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Objects.equals(id, other.id) && Objects.equals(content, other.content)
                ...
                && timestamp == other.timestamp && promptTokens == other.promptTokens
                && completionTokens == other.completionTokens && totalTokens == other.totalTokens
                && Double.compare(cost, other.cost) == 0 && responseTimeMs == other.responseTimeMs
                && Objects.equals(metadata, other.metadata) && Objects.equals(finishReason, other.finishReason)
                && Objects.equals(errorMessage, other.errorMessage);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, content, modelName, providerType, timestamp, promptTokens, completionTokens,
    ...
    public String toString() {
        return "ModelResponse{" + "id='" + id + '\'' + ", content='" + content + '\'' + ", modelName='" + modelName
                + '\'' + ", providerType='" + providerType + '\'' + ", timestamp=" + timestamp + ", promptTokens="
                + promptTokens + ", completionTokens=" + completionTokens + ", totalTokens=" + totalTokens + ", cost="
                + cost + ", responseTimeMs=" + responseTimeMs + ", metadata=" + metadata + ", finishReason='"
                + finishReason + '\'' + ", errorMessage='" + errorMessage + '\'' + '}';
    }
}
