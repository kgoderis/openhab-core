...
/**
 * Action for retrieving trigger information from openHAB Rules.
 * This action provides detailed information about rule triggers including configuration and status.
 * 
 * 
 */
@Component(service = Action.class, immediate = true)
public class GetRuleTriggersAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ExecutionContext context) throws ActionException {
        try {
            ...
            throw new ActionException(getActionId(), "Failed to get rule triggers: " + e.getMessage(), e);
        }
    }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withVersion(getVersion()).withAuthor("openHAB")
                .withDescription(getDescription()).withTags(List.of("rules", "triggers", "automation")).build();
    }
