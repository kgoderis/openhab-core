 ...
 */
@NonNullByDefault
public class GetChannelTypeAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ExecutionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(ACTION_ID, "Failed to get channel type: " + e.getMessage(), e);
        }
    }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withAuthor("openHAB")
                .withDescription("Retrieves detailed information about a channel type").withVersion("1.0.0")
                .withTags(List.of("channels", "types", "things")).build();
    }
