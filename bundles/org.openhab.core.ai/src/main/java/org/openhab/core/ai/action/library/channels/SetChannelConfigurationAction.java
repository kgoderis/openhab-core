 ...
 */
@NonNullByDefault
public class SetChannelConfigurationAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ActionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(ACTION_ID, "Failed to set channel configuration: " + e.getMessage(), e);
        }
    }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().author("openHAB").description("Updates configuration for a specific channel")
