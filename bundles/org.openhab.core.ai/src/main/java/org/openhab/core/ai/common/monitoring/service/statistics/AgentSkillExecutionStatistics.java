...
/**
 * Statistics class for agent skill execution analysis.
 * 
 * <p>
 * This class provides computed statistics and insights about agent skill execution
 ...
 */
@NonNullByDefault
public record AgentSkillExecutionStatistics(List<AgentTaskSnapshot> snapshots, Duration timeRange, long timestampMs)
        implements
            StatisticsSnapshot,
            CountsMetrics,
            LatencyMetrics,
     ...
     * @return agent skill execution statistics
     */
    public static AgentSkillExecutionStatistics fromSnapshots(List<AgentTaskSnapshot> snapshots, Duration timeRange) {
        return new AgentSkillExecutionStatistics(snapshots, timeRange, System.currentTimeMillis());
    }
     ...
     * 
     * @param timeRange the time range for statistics
     * @return empty agent skill execution statistics
     */
    public static AgentSkillExecutionStatistics empty(Duration timeRange) {
        return new AgentSkillExecutionStatistics(List.of(), timeRange, System.currentTimeMillis());
    }

    /**
     * Create statistics from direct counter data (for migration).
     * 
     ...
     * @return agent skill execution statistics
     */
    public static AgentSkillExecutionStatistics fromDirectCounters(long totalExecutions, long successfulExecutions,
