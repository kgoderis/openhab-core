...
public class UpdateAddonAction implements Action {
        ...
        try {
            ...
            if ("update_addon".equals(action) || "check_updates".equals(action) || "rollback_update".equals(action)) {
                ...
                if (addonId == null || addonId.trim().isEmpty()) {
                    return ActionValidationResult.invalid(List.of("addonId is required for this action"));
                }
            }
            ...
            if ("update_from_url".equals(action)) {
                ...
                if (updateUrl == null || updateUrl.trim().isEmpty()) {
                    return ActionValidationResult.invalid(List.of("updateUrl is required for update_from_url action"));
                }
            }
            ...
            if ("update_from_file".equals(action)) {
                ...
                if (filePath == null || filePath.trim().isEmpty()) {
                    return ActionValidationResult.invalid(List.of("filePath is required for update_from_file action"));
                }
            }
    ...
    public ActionResult execute(Map<String, Object> parameters, ActionContext context) throws ActionException {
        try {
            ...
            throw new ActionException(ACTION_ID, "Failed to update addon: " + e.getMessage(), e);
        }
    }
