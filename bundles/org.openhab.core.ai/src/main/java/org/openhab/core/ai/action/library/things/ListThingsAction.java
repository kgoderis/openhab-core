...
/**
 * Action for listing openHAB Things with comprehensive filtering and metadata.
 * This action provides detailed thing information with filtering, sorting, and metadata options.
 * 
 * 
 */
@Component(service = Action.class, immediate = true)
public class ListThingsAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ExecutionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(getActionId(), "Failed to list Things: " + e.getMessage(), e);
        }
    }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withVersion(getVersion()).withAuthor("openHAB")
                .withDescription("List openHAB things with comprehensive filtering and metadata options")
                .withTags(List.of("things", "list", "filter", "metadata", "sorting"))
                .withDocumentation(
                ...
                .withExamples(List.of("List all things: {}", "List only online things: {\"status\": \"ONLINE\"}",
    ...
    private Map<String, Object> listThings(String status, String binding, String thingType, String bridgeUID,
            ...
            boolean includeProperties, String sortBy, String sortOrder, int limit, int offset) throws ActionException {

        if (thingRegistry == null) {
            throw new ActionException(getActionId(), "ThingRegistry not available");
        }
