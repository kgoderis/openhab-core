...
public class LearningPerformanceMetrics {
    ...
    public long getTotalLearningEvents() { return totalLearningEvents; }
    public long getTotalPatternRecognitions() { return totalPatternRecognitions; }
    public long getTotalFeedbackIntegrations() { return totalFeedbackIntegrations; }
    public long getTotalStrategyAdaptations() { return totalStrategyAdaptations; }
    public int getUserPreferenceCount() { return userPreferenceCount; }
    public int getBehaviorPatternCount() { return behaviorPatternCount; }
    public int getFeedbackHistoryCount() { return feedbackHistoryCount; }
    public int getAdaptiveStrategyCount() { return adaptiveStrategyCount; }

    public static LearningPerformanceMetricsBuilder builder() { return new LearningPerformanceMetricsBuilder(); }
}
