...
@NonNullByDefault
public class GetItemHistoryAction implements Action {
    ...
    public ActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (serviceId != null && persistenceServiceRegistry != null) {
            ...
            if (service == null) {
                return ActionValidationResult.invalid(List.of("Persistence service not found: " + serviceId));
            }
    ...
    public ActionResult execute(Map<String, Object> parameters, ActionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(getActionId(), "Failed to get item history: " + e.getMessage(), e);
        }
    }
