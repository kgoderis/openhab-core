 ...
 */
@NonNullByDefault
public class ApproveDiscoveryAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ExecutionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(ACTION_ID, "Failed to approve discovery: " + e.getMessage(), e);
        }
    }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withAuthor("openHAB")
                .withDescription("Approves discovered devices to be added to openHAB as real Things using ThingManager")
                .withVersion("1.0.0").withTags(List.of("discovery", "devices", "approval", "things")).build();
    }
