...
@NonNullByDefault
public class GetItemStateAction implements Action {
    ...
    public ActionValidationResult validateParameters(Map<String, Object> parameters) {
        ...
        if (maxHistoryObj != null) {
            if (!(maxHistoryObj instanceof Integer)) {
                return ActionValidationResult.invalid(List.of("maxHistoryEntries must be an integer"));
            }
            Integer maxHistory = (Integer) maxHistoryObj;
            if (maxHistory <= 0 || maxHistory > 1000) {
                return ActionValidationResult.invalid(List.of("maxHistoryEntries must be between 1 and 1000"));
            }
        }
    ...
    public ActionResult execute(Map<String, Object> parameters, ExecutionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(getActionId(), "Failed to get item state information: " + e.getMessage(), e);
        }
    }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withVersion(getVersion()).withAuthor("openHAB")
                .withDescription("Retrieve detailed state information for openHAB items")
                .withTags(List.of("items", "state", "history", "monitoring"))
                .withDocumentation(
                ...
                .withExamples(List.of("Get current state: {\"itemName\": \"LivingRoom_Light\"}",
