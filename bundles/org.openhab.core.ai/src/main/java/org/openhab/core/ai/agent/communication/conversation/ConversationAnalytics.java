...
public class ConversationAnalytics {
    ...
    public ConversationAnalytics(String conversationId, Instant startTime, @Nullable Instant endTime, long durationMs,
            int participantCount, int messageCount, double messagesPerMinute, Map<String, Integer> participantActivity,
            ConversationState state, @Nullable String endReason) {
    ...
    public Map<String, Integer> getParticipantActivity() {
        return Map.copyOf(participantActivity);
    }
