...
public class ToolRequest {
     ...
     */
    public ToolRequest(String id, String method, Map<String, Object> params) {
    ...
    public boolean equals(@Nullable Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        ToolRequest that = (ToolRequest) o;
    ...
    public String toString() {
        return "ToolRequest{" + "jsonrpc='" + jsonrpc + '\'' + ", id='" + id + '\'' + ", method='" + method + '\''
                + ", params=" + params + '}';
    }
}
