...
public class ConflictEscalationBuilder {
    ...
    public ConflictEscalationBuilder escalatedAt(java.time.Instant escalatedAt) { this.escalatedAt = escalatedAt; return this; }

    public ConflictEscalation build() { return ConflictEscalation.builder().conflictId(conflictId).escalationReason(escalationReason).escalationLevel(escalationLevel).escalatedAt(escalatedAt).build(); }
}
