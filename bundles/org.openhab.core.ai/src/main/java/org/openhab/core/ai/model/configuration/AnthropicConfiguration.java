 ...
 */
@NonNullByDefault
public class AnthropicConfiguration extends BaseProviderConfiguration {

    private final @Nullable String apiKey;
    private final String baseUrl;
    private final double costPer1kTokens;

    public AnthropicConfiguration(boolean enabled, String modelName, double temperature, int maxTokens, int timeoutMs,
