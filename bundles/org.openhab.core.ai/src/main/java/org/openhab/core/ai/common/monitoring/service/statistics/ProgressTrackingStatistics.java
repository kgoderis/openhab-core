...
import org.openhab.core.ai.common.monitoring.api.ProgressMetrics;
import org.openhab.core.ai.common.monitoring.api.TrendMetrics;
import org.openhab.core.ai.common.monitoring.service.snapshot.AgentTaskSnapshot;

/**
 * Statistics class for progress tracking analysis.
 * 
 * <p>
 * This class provides computed statistics and insights about progress tracking
 ...
 */
@NonNullByDefault
public record ProgressTrackingStatistics(List<AgentTaskSnapshot> snapshots, Duration timeRange, long timestampMs)
        implements
            StatisticsSnapshot,
            CountsMetrics,
            LatencyMetrics,
    ...
    // ProgressMetrics implementation
    @Override
     ...
     */
    public static ProgressTrackingStatistics fromSnapshots(List<AgentTaskSnapshot> snapshots, Duration timeRange) {
        return new ProgressTrackingStatistics(snapshots, timeRange, System.currentTimeMillis());
    }
     ...
     * 
     * @param timeRange the time range for statistics
     * @return empty progress tracking statistics
     */
    public static ProgressTrackingStatistics empty(Duration timeRange) {
        return new ProgressTrackingStatistics(List.of(), timeRange, System.currentTimeMillis());
    }
}
