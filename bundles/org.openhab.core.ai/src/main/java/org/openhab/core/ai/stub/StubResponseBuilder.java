...
public class StubResponseBuilder {
    ...
    public StubResponseBuilder message(@Nullable String message) {
        this.message = message;
        return this;
    }

    public StubResponseBuilder data(@Nullable Object data) {
        this.data = data;
        return this;
    }
    ...
    public StubResponseBuilder headers(@Nullable Map<String, String> headers) {
        this.headers = headers;
        return this;
    }

    public StubResponseBuilder timestamp(@Nullable Instant timestamp) {
