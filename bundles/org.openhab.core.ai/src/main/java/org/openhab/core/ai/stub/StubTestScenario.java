...
public class StubTestScenario {
     ...
     */
    public StubTestScenario(String name, Map<String, Object> serviceConfigurations, Object httpConfiguration,
    ...
    public String toString() {
        return "StubTestScenario{" + "name='" + name + '\'' + ", serviceConfigurations=" + serviceConfigurations.size()
                + ", hasHttpConfig=" + (httpConfiguration != null) + ", hasWebSocketConfig="
                + (webSocketConfiguration != null) + ", hasMqttConfig=" + (mqttConfiguration != null) + '}';
    }
}
