...
public class SafetyPerformanceMetricsBuilder {
    ...
    public SafetyPerformanceMetricsBuilder totalSafetyValidations(long v) {
        this.totalSafetyValidations = v;
        return this;
    }

    public SafetyPerformanceMetricsBuilder totalConstraintViolations(long v) {
        this.totalConstraintViolations = v;
        return this;
    }

    public SafetyPerformanceMetricsBuilder totalSafetyIncidents(long v) {
        this.totalSafetyIncidents = v;
        return this;
    }

    public SafetyPerformanceMetricsBuilder totalSafetyOverrides(long v) {
        this.totalSafetyOverrides = v;
        return this;
    }

    public SafetyPerformanceMetricsBuilder safetyPolicyCount(int v) {
        this.safetyPolicyCount = v;
        return this;
    }

    public SafetyPerformanceMetricsBuilder userConstraintCount(int v) {
        this.userConstraintCount = v;
        return this;
    }

    public SafetyPerformanceMetricsBuilder constraintViolationCount(int v) {
        this.constraintViolationCount = v;
        return this;
    }

    public SafetyPerformanceMetricsBuilder safetyIncidentCount(int v) {
        this.safetyIncidentCount = v;
        return this;
    }
