...
public class AgentModelContextCacheStatistics {
    ...
    public double getHitRate() { long total = hits + misses; return total > 0 ? (double) hits / total : 0.0; }
    public double getUtilizationRate() { return maxSize > 0 ? (double) currentSize / maxSize : 0.0; }
