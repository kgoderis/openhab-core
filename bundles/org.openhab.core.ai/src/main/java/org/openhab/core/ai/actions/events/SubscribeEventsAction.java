...
import org.openhab.core.ai.actions.events.EventSubscriptionRegistry.SubscriptionInfo;
 ...
 */
@NonNullByDefault
public class SubscribeEventsAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ActionContext context) throws ActionException {
        try {
            ...
            throw new ActionException(ACTION_ID, "Failed to subscribe to events: " + e.getMessage(), e);
        }
    }
