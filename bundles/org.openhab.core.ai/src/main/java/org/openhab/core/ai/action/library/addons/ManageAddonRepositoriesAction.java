...
public class ManageAddonRepositoriesAction implements Action {
        ...
        try {
            ...
            if ("add_repository".equals(action) || "remove_repository".equals(action)
                ...
                if (repositoryUrl == null || repositoryUrl.trim().isEmpty()) {
                    return ActionValidationResult.invalid(List.of("repositoryUrl is required for this action"));
                }
            }
    ...
    public ActionResult execute(Map<String, Object> parameters, ExecutionContext context) throws ActionException {
        try {
            ...
            throw new ActionException(ACTION_ID, "Failed to manage repositories: " + e.getMessage(), e);
        }
    }
