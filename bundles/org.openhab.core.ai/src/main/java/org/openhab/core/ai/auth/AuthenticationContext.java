...
public class AuthenticationContext {
     ...
     */
    public AuthenticationContext(String principalId, String authenticationScheme, Map<String, String> credentials,
    ...
    public String toString() {
        ...
        return "AuthenticationContext{" + "principalId='" + principalId + '\'' + ", authenticationScheme='"
