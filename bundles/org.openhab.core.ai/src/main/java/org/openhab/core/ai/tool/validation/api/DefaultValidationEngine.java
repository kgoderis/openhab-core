...
public class DefaultValidationEngine implements ValidationEngine {
    ...
    public void registerRule(ValidationRule rule) {
        if (rule != null && rule.getRuleId() != null) {
            ...
            if (metrics != null) {
                try {
                    metrics.recordOperation("validation", "rule_registration").withSuccess(true).withDuration(0L)
                            .withData("ruleId", rule.getRuleId()).withData("rulePriority", rule.getPriority()).record();
                } catch (Exception e) {
                    LOGGER.warn("Failed to record rule registration metrics for rule {}: {}", rule.getRuleId(),
                            e.getMessage());
    ...
    public void unregisterRule(String ruleId) {
        if (ruleId != null) {
            ...
            if (metrics != null) {
                try {
                    metrics.recordOperation("validation", "rule_unregistration").withSuccess(true).withDuration(0L)
                            .withData("ruleId", ruleId).record();
                } catch (Exception e) {
    ...
    public ValidationRule getRule(String ruleId) {
        ...
        if (metrics != null) {
            try {
                metrics.recordOperation("validation", "get_rule").withSuccess(rule != null).withDuration(0L)
                        .withData("ruleId", ruleId != null ? ruleId : "null").withData("found", rule != null).record();
            } catch (Exception e) {
    ...
    public List<ValidationRule> getAllRules() {
        ...
        if (metrics != null) {
            try {
                metrics.recordOperation("validation", "list_rules").withSuccess(true).withDuration(0L)
                        .withData("ruleCount", rules.size()).record();
            } catch (Exception e) {
    ...
    public ToolValidationResult validate(Map<String, Object> data) {
        ...
        if (metrics != null) {
            try {
                metrics.recordOperation("validation", "start_all_rules").withSuccess(true).withDuration(0L)
                        .withData("ruleCount", rules.size()).record();
            } catch (Exception e) {
    ...
    public void setRuleEnabled(String ruleId, boolean enabled) {
        ...
        if (rule != null) {
            ...
            if (metrics != null) {
                try {
                    metrics.recordOperation("validation", "rule_state_change").withSuccess(true).withDuration(0L)
                            .withData("ruleId", ruleId).withData("enabled", enabled).record();
                } catch (Exception e) {
    ...
    private List<ValidationRule> getRulesByIds(List<String> ruleIds) {
        ...
        for (String ruleId : ruleIds) {
            ...
            if (rule != null) {
                ...
                if (metrics != null) {
                    try {
                        metrics.recordOperation("validation", "missing_rule").withSuccess(false).withDuration(0L)
                                .withData("ruleId", ruleId).record();
                    } catch (Exception e) {
    ...
    private ToolValidationResult executeRule(ValidationRule rule, Map<String, Object> data) {
        ...
        try {
            ...
            if (metrics != null) {
                try {
                    metrics.recordOperation("rule", "execution").withSuccess(result.isValid())
                            .withDuration(Duration.ofMillis(executionTime).toNanos())
                            .withData("ruleId", rule.getRuleId()).withData("executionTimeMs", executionTime)
                            .withData("validationErrors", result.getErrors().size())
                            .withData("validationWarnings", result.getWarnings().size()).record();
                } catch (Exception e) {
            ...
            if (metrics != null) {
                try {
                    metrics.recordOperation("rule", "execution").withSuccess(false)
                            .withDuration(Duration.ofMillis(executionTime).toNanos())
                            .withData("ruleId", rule.getRuleId()).withData("executionTimeMs", executionTime)
    ...
    private void recordValidationMetrics(String validationType, boolean success, long durationMs) {
        ...
        if (metrics != null) {
            try {
                metrics.recordOperation("validation", validationType).withSuccess(success)
                        .withDuration(Duration.ofMillis(durationMs).toNanos())
                        .withData("validationType", validationType).withData("durationMs", durationMs).record();
            } catch (Exception e) {
    ...
    private ToolValidationResult aggregateResults(List<ToolValidationResult> results, List<String> errors,
        ...
        if (metrics != null) {
            try {
                metrics.recordOperation("validation", "aggregation").withSuccess(isValid).withDuration(0L)
                        .withData("totalRules", results.size())
                        .withData("passedRules", (int) results.stream().filter(ToolValidationResult::isValid).count())
                        .withData("errorCount", errors.size()).withData("warningCount", warnings.size()).record();
            } catch (Exception e) {
