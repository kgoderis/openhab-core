...
public class SearchItemsAction implements Action {
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withVersion(getVersion()).withAuthor("openHAB")
                .withDescription("Search for openHAB items based on various criteria")
                .withTags(List.of("items", "search", "filter", "query"))
                .withDocumentation(
                ...
                .withExamples(List.of("Search by name: {\"namePattern\": \"*Light*\"}",
