...
/**
 * Action for retrieving detailed CPU information including load, processors, and thread statistics.
 * 
 * This action provides comprehensive CPU diagnostics using real Java Management APIs.
 */
@Component(service = Action.class, immediate = true)
public class CPUInfoAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ActionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(ACTION_ID, "Failed to collect CPU information: " + e.getMessage(), e);
        }
    }
