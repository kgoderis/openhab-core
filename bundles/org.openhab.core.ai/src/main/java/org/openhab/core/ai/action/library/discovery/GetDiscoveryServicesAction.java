...
public class GetDiscoveryServicesAction implements Action {
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withAuthor("openHAB")
                .withDescription("Gets information about available discovery services").withVersion("1.0.0")
                .withTags(List.of("discovery", "services", "capabilities", "configuration")).build();
    }
