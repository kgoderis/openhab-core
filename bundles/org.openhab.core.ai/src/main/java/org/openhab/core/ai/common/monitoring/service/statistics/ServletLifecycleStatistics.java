...
/**
 * Statistics class for servlet lifecycle analysis.
 * 
 * <p>
 * This class provides computed statistics and insights about servlet lifecycle
 ...
 */
@NonNullByDefault
public record ServletLifecycleStatistics(List<AgentTaskSnapshot> snapshots, Duration timeRange, long timestampMs)
        implements
            StatisticsSnapshot,
            CountsMetrics,
            LatencyMetrics,
     ...
     * @return servlet lifecycle statistics
     */
    public static ServletLifecycleStatistics fromSnapshots(List<AgentTaskSnapshot> snapshots, Duration timeRange) {
        return new ServletLifecycleStatistics(snapshots, timeRange, System.currentTimeMillis());
    }
     ...
     * 
     * @param timeRange the time range for statistics
     * @return empty servlet lifecycle statistics
     */
    public static ServletLifecycleStatistics empty(Duration timeRange) {
        return new ServletLifecycleStatistics(List.of(), timeRange, System.currentTimeMillis());
    }
}
