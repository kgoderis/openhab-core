...
/**
 * Action for getting item metadata in openHAB.
 * 
 * This action provides functionality to retrieve
 * metadata for items including properties and configuration.
 * 
 * @author Karel Goderis - Initial Contribution
 * @since 1.0.0
 */
@NonNullByDefault
public class GetItemMetadataAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ExecutionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(getActionId(), "Failed to get item metadata: " + e.getMessage(), e);
        }
    }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withVersion(getVersion()).withAuthor("openHAB")
                .withDescription("Retrieve metadata information for openHAB items")
                .withTags(List.of("items", "metadata", "configuration", "properties"))
                .withDocumentation(
                ...
                .withExamples(List.of("Get all metadata: {\"itemName\": \"LivingRoom_Light\"}",
