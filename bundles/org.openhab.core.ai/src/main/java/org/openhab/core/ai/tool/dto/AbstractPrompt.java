...
public abstract class AbstractPrompt {
    ...
    protected static final Logger LOGGER = LoggerFactory.getLogger(AbstractPrompt.class);
     ...
     */
    protected AbstractPrompt(String name, String description, List<Prompt.PromptArgument> arguments,
    ...
    public String toString() {
        return "AbstractPrompt{name='" + name + "', description='" + description + "', arguments=" + arguments
                + ", valid=" + valid + "}";
    }
}
