...
/**
 * Action for retrieving execution history of openHAB Rules.
...
public class GetRuleHistoryAction implements Action {
    ...
    public ActionValidationResult validateParameters(Map<String, Object> parameters) {
        try {
            ...
            if (ruleUID == null || ruleUID.trim().isEmpty()) {
                return ActionValidationResult.invalid(List.of("ruleUID is required"));
            }
            ...
            if (startTime != null) {
                try {
                    ...
                    return ActionValidationResult.invalid(List.of("Invalid startTime format: " + e.getMessage()));
                }
            }
            ...
            if (endTime != null) {
                try {
                    ...
                    return ActionValidationResult.invalid(List.of("Invalid endTime format: " + e.getMessage()));
                }
            }
            ...
            if (maxEntriesObj != null) {
                ...
                if (maxEntries < 1 || maxEntries > 1000) {
                    return ActionValidationResult.invalid(List.of("maxEntries must be between 1 and 1000"));
                }
            }
    ...
    public ActionResult execute(Map<String, Object> parameters, ExecutionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(getActionId(), "Failed to get rule history: " + e.getMessage(), e);
        }
    }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withVersion(getVersion()).withAuthor("openHAB")
                .withDescription(getDescription()).withTags(List.of("rules", "history", "monitoring")).build();
    }
