 ...
 */
@NonNullByDefault
public class GetDiscoveryResultsAction implements Action {
    ...
    public ActionResult execute(Map<String, Object> parameters, ExecutionContext context) throws ActionException {
        ...
        try {
            ...
            throw new ActionException(ACTION_ID, "Failed to get discovery results: " + e.getMessage(), e);
        }
    }
    ...
    public ActionMetadata getMetadata() {
        return ActionMetadata.builder().withAuthor("openHAB")
                .withDescription("Gets real discovery results from openHAB Inbox using actual DiscoveryResult objects")
                .withVersion("1.0.0").withTags(List.of("discovery", "devices", "inbox", "results")).build();
    }
