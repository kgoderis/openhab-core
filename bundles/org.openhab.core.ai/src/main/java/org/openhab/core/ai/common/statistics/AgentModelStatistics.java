...
/**
 * Unified Agent Model Statistics implementation.
 * 
 * <p>
 * This class provides comprehensive statistics for agent model operations,
 * including request counts, response times, cache performance, and error tracking.
 * </p>
 * 
 ...
 */
@NonNullByDefault
public final class AgentModelStatistics extends BaseStatistics {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Objects.equals(agentId, other.agentId) && totalRequests == other.totalRequests
                && successfulRequests == other.successfulRequests && failedRequests == other.failedRequests
                && cacheHits == other.cacheHits && cacheMisses == other.cacheMisses
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), agentId, totalRequests, successfulRequests, failedRequests, cacheHits,
                cacheMisses, totalResponseTimeMs, averageResponseTimeMs, minResponseTimeMs, maxResponseTimeMs,
                totalTokensUsed, totalCost, lastRequestTime, lastSuccessTime, lastFailureTime, lastError);
    }

    @Override
    public String toString() {
        return String.format(
                "AgentModelStatistics{id='%s', agentId='%s', totalRequests=%d, successfulRequests=%d, failedRequests=%d, cacheHitRate=%.2f%%, successRate=%.2f%%}",
                getId(), agentId, totalRequests, successfulRequests, failedRequests, getCacheHitRate(),
                getSuccessRate());
    }

    public static final class Builder extends AbstractBuilder<AgentModelStatistics> {
        private String id = "";
        ...
        public Builder(AgentModelStatistics source) {
        ...
        protected void validate() {
            ...
            if (agentId.trim().isEmpty()) {
                addValidationError("agentId cannot be blank");
            }
            if (totalRequests < 0) {
