...
import org.openhab.core.ai.action.actions.items.*;
import org.openhab.core.items.Item;

/**
 * Integration tests for Items-related Actions using mocked openHAB services.
 */
class ItemsActionIntegrationTest extends BaseActionIntegrationTest {
    ...
    void testGetItemAction() throws Exception {
        ...
        ActionResult result = executeAction(getItemAction, parameters);
    ...
    void testListItemsAction() throws Exception {
        ...
        ActionResult result = executeAction(listItemsAction, parameters);
    ...
    void testCreateItemAction() throws Exception {
        ...
        ActionResult result = executeAction(createItemAction, parameters);
    ...
    void testUpdateItemAction() throws Exception {
        ...
        Map<String, Object> updateParams = Map.of("itemName", "UpdateTestSwitch", "label", "Updated Label", "category",
                "updated_switch");
        ActionResult result = executeAction(updateItemAction, updateParams);
    ...
    void testDeleteItemAction() throws Exception {
        ...
        ActionResult result = executeAction(deleteItemAction, deleteParams);
    ...
    void testGetItemStateAction() throws Exception {
        Map<String, Object> parameters = Map.of("itemName", "TestSwitch");
        ActionResult result = executeAction(getItemStateAction, parameters);
    ...
    void testSetItemStateAction() throws Exception {
        ...
        ActionResult result = executeAction(setItemStateAction, parameters);
    ...
    void testSendItemCommandAction() throws Exception {
        ...
        ActionResult result = executeAction(sendItemCommandAction, parameters);
    ...
    void testGetItemMetadataAction() throws Exception {
        Map<String, Object> parameters = Map.of("itemName", "TestSwitch");
        ActionResult result = executeAction(getItemMetadataAction, parameters);
    ...
    void testSetItemMetadataAction() throws Exception {
        ...
        ActionResult result = executeAction(setItemMetadataAction, parameters);
        ...
        ActionResult getResult = executeAction(getItemMetadataAction, getParams);
    ...
    void testGetItemTagsAction() throws Exception {
        Map<String, Object> parameters = Map.of("itemName", "TestSwitch");
        ActionResult result = executeAction(getItemTagsAction, parameters);
    ...
    void testSetItemTagsAction() throws Exception {
        ...
        ActionResult result = executeAction(setItemTagsAction, parameters);
        ...
        Map<String, Object> getParams = Map.of("itemName", "TestSwitch");
        ActionResult getResult = executeAction(getItemTagsAction, getParams);
        assertSuccess(getResult);
    }
    ...
    void testGetItemTypeAction() throws Exception {
        Map<String, Object> parameters = Map.of("itemName", "TestSwitch");
        ActionResult result = executeAction(getItemTypeAction, parameters);
    ...
    void testGetItemBindingAction() throws Exception {
        Map<String, Object> parameters = Map.of("itemName", "TestSwitch");
        ActionResult result = executeAction(getItemBindingAction, parameters);
    ...
    void testGetItemGroupsAction() throws Exception {
        Map<String, Object> parameters = Map.of("itemName", "TestSwitch");
        ActionResult result = executeAction(getItemGroupsAction, parameters);
    ...
    void testGetItemHistoryAction() throws Exception {
        ...
        ActionResult result = executeAction(getItemHistoryAction, parameters);
    ...
    void testGetItemStatisticsAction() throws Exception {
        Map<String, Object> parameters = Map.of("itemName", "TestNumber", "startTime", "2024-01-01T00:00:00Z",
                "endTime", "2024-12-31T23:59:59Z");
        ActionResult result = executeAction(getItemStatisticsAction, parameters);
    ...
    void testValidateItemAction() throws Exception {
        Map<String, Object> parameters = Map.of("itemName", "TestSwitch");
        ActionResult result = executeAction(validateItemAction, parameters);
    ...
    void testSearchItemsAction() throws Exception {
        ...
        ActionResult result = executeAction(searchItemsAction, parameters);
    ...
    void testBulkItemOperationsAction() throws Exception {
        ...
        Map<String, Object> bulkParams = Map.of("operation", "setState", "items", List.of("BulkTest1", "BulkTest2"),
                "state", "ON");
        ActionResult result = executeAction(bulkItemOperationsAction, bulkParams);
