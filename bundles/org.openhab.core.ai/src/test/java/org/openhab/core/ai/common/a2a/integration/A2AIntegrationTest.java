...
import org.openhab.core.ai.agent.internal.AgentConfigurationManager;
...
import org.openhab.core.ai.agent.internal.AgentTaskSchemaGenerator;
...
public class A2AIntegrationTest {
    ...
    @Mock
    private AgentTaskSchemaGenerator schemaGenerator;
    ...
    public void setUp() {
        ...
        agentExecutor = new AgentAgentExecutor();
    ...
    public void testAgentRegistryIntegration() throws Exception {
        ...
        Agent registeredAgent = agentRegistry.getAgent(agentId);
        ...
        Agent.AgentStatus status = agentRegistry.getAgentStatus(agentId);
        assertNotNull(status);
        assertEquals(Agent.AgentStatus.RUNNING, status);
    }
