...
class AgentOpenHABPersistenceManagerTest {
    ...
    @BeforeEach
    void setUp() {
        persistenceManager = new AgentOpenHABPersistenceManager();
    ...
    void testDeactivate() {
        ...
        verify(mockReadyService, times(1)).unmarkReady(AgentOpenHABPersistenceManager.A2A_PERSISTENCE_OPENHAB_READY);
        verify(mockReadyService, times(1)).unmarkReady(AgentOpenHABPersistenceManager.A2A_CONFIGURATION_OPENHAB_READY);
    }
    ...
    void testSaveTaskWithOpenHABStorage() {
        ...
        AgentOpenHABPersistenceManager.TaskExecutionState executionState = new AgentOpenHABPersistenceManager.TaskExecutionState(
    ...
    void testTaskExecutionState() {
        ...
        AgentOpenHABPersistenceManager.TaskExecutionState state = new AgentOpenHABPersistenceManager.TaskExecutionState(
                "test-task-1", TaskState.SUBMITTED, "test-executor");
