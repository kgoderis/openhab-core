...
import org.openhab.core.ai.transport.A2AServlet;
...
class A2AServletTest {
    ...
    private A2AServlet servlet;
    private StringWriter stringWriter;
    private PrintWriter printWriter;

    @BeforeEach
    void setUp() throws Exception {
        servlet = new A2AServlet();
    ...
    void testGetServerStatistics() {
        // When
        A2AServlet.ServerStatistics stats = servlet.getServerStatistics();
