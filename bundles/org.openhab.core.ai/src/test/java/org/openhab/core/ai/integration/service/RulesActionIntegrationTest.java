...
import org.openhab.core.ai.action.actions.rules.*;

/**
 * Integration tests for Rules-related Actions using mocked openHAB services.
 */
class RulesActionIntegrationTest extends BaseActionIntegrationTest {
    ...
    void testListRulesAction() throws Exception {
        ...
        ActionResult result = executeAction(listRulesAction, parameters);
    ...
    void testGetRuleAction() throws Exception {
        ...
        ActionResult result = executeAction(getRuleAction, parameters);
    ...
    void testCreateRuleAction() throws Exception {
        ...
        ActionResult result = executeAction(createRuleAction, parameters);
    ...
    void testUpdateRuleAction() throws Exception {
        ...
        ActionResult result = executeAction(updateRuleAction, parameters);
    ...
    void testDeleteRuleAction() throws Exception {
        Map<String, Object> parameters = Map.of("ruleUID", "test-rule-1");
        ActionResult result = executeAction(deleteRuleAction, parameters);
    ...
    void testGetRuleStatusAction() throws Exception {
        Map<String, Object> parameters = Map.of("ruleUID", "test-rule-1");
        ActionResult result = executeAction(getRuleStatusAction, parameters);
    ...
    void testEnableRuleAction() throws Exception {
        Map<String, Object> parameters = Map.of("ruleUID", "test-rule-1");
        ActionResult result = executeAction(enableRuleAction, parameters);
    ...
    void testDisableRuleAction() throws Exception {
        Map<String, Object> parameters = Map.of("ruleUID", "test-rule-1");
        ActionResult result = executeAction(disableRuleAction, parameters);
    ...
    void testExecuteRuleAction() throws Exception {
        Map<String, Object> parameters = Map.of("ruleUID", "test-rule-1");
        ActionResult result = executeAction(executeRuleAction, parameters);
    ...
    void testGetRuleTriggersAction() throws Exception {
        Map<String, Object> parameters = Map.of("ruleUID", "test-rule-1");
        ActionResult result = executeAction(getRuleTriggersAction, parameters);
    ...
    void testGetRuleConditionsAction() throws Exception {
        Map<String, Object> parameters = Map.of("ruleUID", "test-rule-1");
        ActionResult result = executeAction(getRuleConditionsAction, parameters);
    ...
    void testGetRuleActionsAction() throws Exception {
        Map<String, Object> parameters = Map.of("ruleUID", "test-rule-1");
        ActionResult result = executeAction(getRuleActionsAction, parameters);
    ...
    void testGetRuleHistoryAction() throws Exception {
        ...
        ActionResult result = executeAction(getRuleHistoryAction, parameters);
    ...
    void testGetRuleStatisticsAction() throws Exception {
        Map<String, Object> parameters = Map.of("ruleUID", "test-rule-1", "startTime", "2024-01-01T00:00:00Z",
                "endTime", "2024-12-31T23:59:59Z");
        ActionResult result = executeAction(getRuleStatisticsAction, parameters);
    ...
    void testValidateRuleAction() throws Exception {
        Map<String, Object> parameters = Map.of("ruleName", "Test Rule", "triggers",
                ...
                List.of(Map.of("type", "ItemStateCondition", "itemName", "TestSwitch", "state", "ON")), "actions",
                List.of(Map.of("type", "ItemCommandAction", "itemName", "TestNumber", "command", "42")));
        ActionResult result = executeAction(validateRuleAction, parameters);
    ...
    void testSearchRulesAction() throws Exception {
        ...
        ActionResult result = executeAction(searchRulesAction, parameters);
    ...
    void testBulkRuleOperationsAction() throws Exception {
        ...
        ActionResult result = executeAction(bulkRuleOperationsAction, parameters);
