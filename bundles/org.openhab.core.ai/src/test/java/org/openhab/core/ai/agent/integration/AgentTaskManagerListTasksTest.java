...
/**
 * Integration tests for Agent Task Manager List Tasks functionality.
 * 
...
class AgentTaskManagerListTasksTest {
    ...
    @BeforeEach
    void setUp() {
        // TODO: Initialize agent task manager when classes are available
    }
