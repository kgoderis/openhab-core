...
This directory contains comprehensive integration tests for all Actions in the openHAB AI Common bundle using mocked openHAB services.

## Test Architecture

### Base Test Class: `BaseActionIntegrationTest`
...
Tests all thing-related Actions:
...
Tests all persistence-related Actions:
...
Tests all channel-related Actions:
...
Tests all rule-related Actions:
...
Tests all addon-related Actions:
...
Tests all script-related Actions:
...
Tests all discovery-related Actions:
...
Tests all event-related Actions:
...
Tests all filesystem-related Actions:
...
Tests all network-related Actions:
...
Tests all security-related Actions:
...
Tests all monitoring-related Actions:
...
Tests all analytics-related Actions:
...
Tests all automation-related Actions:
...
Tests all configuration-related Actions:
...
Tests all resources-related Actions:
...
Tests all system-related Actions:
...
Action initialization failed
```
**Solution**: Check that the Action classes are properly implemented and can be instantiated.
