...
class MCPServerInstanceTest {
    ...
    private ToolServerConfiguration configuration;

    @BeforeEach
    void setUp() {
        // Create a basic configuration for testing
        configuration = ToolServerConfiguration.builder().serverId("test-server").serverName("Test MCP Server")
    ...
    void testServerCapabilitiesConfiguration() {
        ...
        ToolServerConfiguration fullConfig = ToolServerConfiguration.builder().serverId("full-server").enableTools(true)
    ...
    void testServerWithTransportOptions() {
        ...
        ToolServerConfiguration configWithOptions = ToolServerConfiguration.builder().serverId("options-server")
    ...
    void testServerConfigurationBuilder() {
        ...
        ToolServerConfiguration builtConfig = ToolServerConfiguration.builder().serverId("builder-test")
    ...
    void testServerConfigurationEquality() {
        ...
        ToolServerConfiguration config1 = ToolServerConfiguration.builder().serverId("test").serverName("Test").build();

        ToolServerConfiguration config2 = ToolServerConfiguration.builder().serverId("test").serverName("Test").build();

        ToolServerConfiguration config3 = ToolServerConfiguration.builder().serverId("different").serverName("Test")
                .build();
