...
import org.openhab.core.ai.tool.internal.MCPTransportType;
...
class MCPServerConfigurationTest {
    ...
    void testFullConfiguration() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("full-server")
    ...
    void testDefaultValues() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("default-server").build();
    ...
    void testTransportOptions() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("transport-server")
    ...
    void testServerOptions() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("server-options")
    ...
    void testIndividualTransportOption() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("individual-transport")
    ...
    void testIndividualServerOption() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("individual-server")
    ...
    void testEquality() {
        // Test equality
        ToolServerConfiguration config1 = ToolServerConfiguration.builder().serverId("test-server")
                .serverName("Test Server").build();

        ToolServerConfiguration config2 = ToolServerConfiguration.builder().serverId("test-server")
                .serverName("Test Server").build();

        ToolServerConfiguration config3 = ToolServerConfiguration.builder().serverId("different-server")
                .serverName("Test Server").build();
    ...
    void testNullValues() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("null-test")
                .serverName("test-server").serverVersion("1.0.0").baseUrl(null).messageEndpoint(null).sseEndpoint(null)
                .authToken(null).oauthIssuerUrl(null).oauthClientId(null).oauthClientSecret(null).oauthRedirectUri(null)
    ...
    void testEmptyValues() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("empty-test")
    ...
    void testSpecialCharacters() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("test@server#123")
    ...
    void testUnicodeCharacters() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("test-服务器-123")
    ...
    void testLargeValues() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("a".repeat(1000))
    ...
    void testTransportTypeConfiguration() {
        ...
        ToolServerConfiguration stdioConfig = ToolServerConfiguration.builder().serverId("stdio-server")
                .transportType(MCPTransportType.STDIO).build();

        ToolServerConfiguration sseConfig = ToolServerConfiguration.builder().serverId("sse-server")
    ...
    void testServerOptionsOverlap() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("overlap-test")
    ...
    void testTransportOptionsOverlap() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("transport-overlap")
    ...
    void testNullOptions() {
        ...
        assertThrows(NullPointerException.class, () -> {
            ToolServerConfiguration.builder().serverId("null-options").serverOptions(null).transportOptions(null)
                    .build();
        });
    }
    ...
    void testImmutability() {
        ...
        ToolServerConfiguration config = ToolServerConfiguration.builder().serverId("immutable-test").build();
