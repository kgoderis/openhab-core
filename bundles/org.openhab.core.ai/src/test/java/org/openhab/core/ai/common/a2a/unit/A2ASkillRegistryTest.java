...
class AgentSkillRegistryTest {
    ...
    @Test
    void testExecuteSkill() throws AgentSkillException {
    ...
    void testReadyMarkerConstants() {
        ...
        assertNotNull(AgentSkillRegistry.A2A_SKILLS_READY);
        assertEquals("a2a", AgentSkillRegistry.A2A_SKILLS_READY.getType());
        assertEquals("skills", AgentSkillRegistry.A2A_SKILLS_READY.getIdentifier());
    }
