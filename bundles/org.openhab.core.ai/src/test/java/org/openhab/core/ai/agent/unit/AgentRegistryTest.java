package org.openhab.core.ai.agent.unit;
...
import org.openhab.core.ai.agent.AgentRegistry.AgentCommunicationProtocol;
import org.openhab.core.ai.agent.AgentRegistry.AgentMessage;
import org.openhab.core.ai.agent.AgentRegistry.AgentRegistrationResult;
import org.openhab.core.ai.agent.AgentRegistry.AgentSecurityContext;
import org.openhab.core.ai.agent.AgentRegistry.AgentValidationResult;
...
public class AgentRegistryTest {
    ...
    /**
     * Simple test implementation of Agent to avoid mocking issues
     */
    private static class TestAgentAgent implements Agent {
        ...
        public AgentStatus getStatus() {
            return running ? AgentStatus.BUSY : AgentStatus.IDLE;
        }
        ...
        @Override
        public void subscribeToTaskUpdates(String taskId, Consumer<TaskStatusUpdateEvent> callback) {
            // No-op for testing
        }

        @Override
        public void unsubscribeFromTaskUpdates(String taskId) {
            // No-op for testing
        }
        ...
        public java.util.Map<String, Object> getConfiguration() {
            return java.util.Map.of("test", "config");
        }

        @Override
        public boolean updateConfiguration(java.util.Map<String, Object> configuration) {
            return true;
        }
