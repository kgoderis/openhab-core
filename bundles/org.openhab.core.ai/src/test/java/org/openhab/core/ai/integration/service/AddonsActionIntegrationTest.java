...
/**
 * Integration tests for Addons-related Actions using mocked openHAB services.
 */
class AddonsActionIntegrationTest extends BaseActionIntegrationTest {
    ...
    void testListAddonsAction() throws Exception {
        ...
        ActionResult result = executeAction(listAddonsAction, parameters);
    ...
    void testGetAddonAction() throws Exception {
        ...
        ActionResult result = executeAction(getAddonAction, parameters);
    ...
    void testInstallAddonAction() throws Exception {
        Map<String, Object> parameters = Map.of("addonId", "binding-hue");
        ActionResult result = executeAction(installAddonAction, parameters);
    ...
    void testUninstallAddonAction() throws Exception {
        Map<String, Object> parameters = Map.of("addonId", "binding-hue");
        ActionResult result = executeAction(uninstallAddonAction, parameters);
    ...
    void testUpdateAddonAction() throws Exception {
        Map<String, Object> parameters = Map.of("addonId", "binding-hue");
        ActionResult result = executeAction(updateAddonAction, parameters);
    ...
    void testGetAddonInfoAction() throws Exception {
        Map<String, Object> parameters = Map.of("addonId", "binding-hue");
        ActionResult result = executeAction(getAddonInfoAction, parameters);
    ...
    void testGetAddonStatusAction() throws Exception {
        Map<String, Object> parameters = Map.of("addonId", "binding-hue");
        ActionResult result = executeAction(getAddonStatusAction, parameters);
    ...
    void testGetAddonDependenciesAction() throws Exception {
        Map<String, Object> parameters = Map.of("addonId", "binding-hue");
        ActionResult result = executeAction(getAddonDependenciesAction, parameters);
    ...
    void testCheckAddonCompatibilityAction() throws Exception {
        Map<String, Object> parameters = Map.of("addonId", "binding-hue");
        ActionResult result = executeAction(checkAddonCompatibilityAction, parameters);
    ...
    void testCheckAddonHealthAction() throws Exception {
        Map<String, Object> parameters = Map.of("addonId", "binding-hue");
        ActionResult result = executeAction(checkAddonHealthAction, parameters);
    ...
    void testSearchAddonsAction() throws Exception {
        ...
        ActionResult result = executeAction(searchAddonsAction, parameters);
    ...
    void testManageAddonRepositoriesAction() throws Exception {
        ...
        ActionResult result = executeAction(manageAddonRepositoriesAction, parameters);
    ...
    void testBackupAddonConfigurationAction() throws Exception {
        Map<String, Object> parameters = Map.of("addonId", "binding-hue");
        ActionResult result = executeAction(backupAddonConfigurationAction, parameters);
