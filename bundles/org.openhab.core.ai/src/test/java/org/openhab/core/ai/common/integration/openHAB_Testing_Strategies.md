...
class ListItemsActionMockedTest {
    ...
    @Test
    void testListAllItems() throws ActionException {
        // Setup mock data
    ...
    @Test
    void testListItemsByType() throws ActionException {
        // Setup mock data
        when(mockItemRegistry.getItems())
            .thenReturn(List.of(mockSwitchItem, mockNumberItem, mockStringItem));
    ...
    @Test
    void testListItemsByNamePattern() throws ActionException {
        // Setup mock data
        when(mockItemRegistry.getItems())
            .thenReturn(List.of(mockSwitchItem, mockNumberItem, mockStringItem));
    ...
    @Test
    void testEmptyItemRegistry() throws ActionException {
    ...
    @Test
    void testItemRegistryUnavailable() throws ActionException {
        // Setup null service
        when(mockContext.getService(ItemRegistry.class))
            .thenReturn(null);
...
```java
package org.openhab.core.ai.actions.things;
...
class ListThingsActionMockedTest {
    ...
    @Test
    void testListAllThings() throws ActionException {
        // Setup mock data
    ...
    @Test
    void testListThingsByStatus() throws ActionException {
        // Setup mock data
        when(mockThingRegistry.getAll())
            .thenReturn(List.of(mockThing1, mockThing2));
...
class ItemsActionOSGiTest {
    ...
    @Test
    void testListItemsWithRealRegistry() throws ActionException {
        // Execute action
        Map<String, Object> parameters = Map.of("filter", "all");
        ActionResult result = action.execute(parameters, actionContext);
    ...
    @Test
    void testItemOperationsWithRealRegistry() throws ActionException {
...
class PersistenceActionOSGiTest {
    ...
    @Test
    void testPersistenceWithRealServices() throws ActionException {
    ...
    @Test
    void testPersistenceDataOperations() throws ActionException {
...
```java
package org.openhab.core.ai.integration.live;
...
class LiveOpenHABIntegrationTest {
    ...
    @Test
    void testListItemsFromLiveOpenHAB() throws ActionException {
    ...
    @Test
    void testItemStateOperations() throws ActionException {
    ...
    @Test
    void testPersistenceWithLiveData() throws ActionException {
        ...
        ActionResult result = persistenceAction.execute(parameters, actionContext);
        assertTrue(result.isSuccess());
    ...
    private ActionContext createLiveActionContext() {
...
```java
package org.openhab.core.ai.integration.docker;
...
class DockerOpenHABIntegrationTest {
    ...
    @Test
    void testWithDockerOpenHAB() throws ActionException {
    ...
    private ActionContext createDockerActionContext() {
...
```java
package org.openhab.core.ai.test.config;
...
```java
package org.openhab.core.ai.test.conditional;
...
import org.openhab.core.ai.api.action.ActionException;
import org.openhab.core.ai.api.action.ActionResult;
import org.openhab.core.ai.test.config.TestConfiguration;
import org.openhab.core.test.java.JavaOSGiTest;
...
class ConditionalItemsActionTest {
    ...
    @Test
    void testListItems() throws ActionException {
    ...
    void testLiveSpecificFeatures() throws ActionException {
    ...
    void testEmbeddedSpecificFeatures() throws ActionException {
    ...
    void testMockedSpecificFeatures() throws ActionException {
