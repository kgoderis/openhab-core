...
import org.openhab.core.ai.tool.internal.ToolErrorRecoveryManager;
...
class MCPErrorRecoveryManagerTest {
    ...
    private ToolErrorRecoveryManager errorRecoveryManager;

    @BeforeEach
    void setUp() {
        config = ToolServerConfiguration.builder().serverId("test-server").serverName("Test Server").build();
        errorRecoveryManager = new ToolErrorRecoveryManager(auditLogger);
    }
    ...
    void testHandleError() {
        ...
        ToolErrorRecoveryManager.RecoveryAction action = errorRecoveryManager.handleError("network_error",
                "Connection failed", "client-123");

        assertNotNull(action);
        assertTrue(action == ToolErrorRecoveryManager.RecoveryAction.RETRY
                || action == ToolErrorRecoveryManager.RecoveryAction.FALLBACK
                || action == ToolErrorRecoveryManager.RecoveryAction.DEGRADE);
    }

    @Test
    void testHandleErrorWithNullClientId() {
        // Test handling an error with null client ID
        ToolErrorRecoveryManager.RecoveryAction action = errorRecoveryManager.handleError("tool_error",
    ...
    void testHandleErrorWithNullErrorType() {
        ...
        ToolErrorRecoveryManager.RecoveryAction action = errorRecoveryManager.handleError(null, "Some error occurred",
                "client-123");
    ...
    void testHandleErrorWithNullErrorMessage() {
        ...
        ToolErrorRecoveryManager.RecoveryAction action = errorRecoveryManager.handleError("unknown_error", null,
                "client-123");
    ...
    void testGetErrorRecoveryStatistics() {
        ...
        ToolErrorRecoveryManager.ErrorRecoveryStatistics stats = errorRecoveryManager.getErrorRecoveryStatistics();
        assertNotNull(stats);
    ...
    void testGetErrorDetails() {
        ...
        Map<String, ToolErrorRecoveryManager.ErrorInfo> errorDetails = errorRecoveryManager.getErrorDetails();
    ...
    void testGetErrorDetailsAfterErrors() {
        ...
        ToolErrorRecoveryManager.ErrorInfo errorInfo = errorDetails.get("test_error");
    ...
    void testErrorInfoCreation() {
        ...
        ToolErrorRecoveryManager.ErrorInfo errorInfo = new ToolErrorRecoveryManager.ErrorInfo(5,
    ...
    void testErrorInfoWithValidCircuitBreakerState() {
        ...
        ToolErrorRecoveryManager.ErrorInfo errorInfo = new ToolErrorRecoveryManager.ErrorInfo(3,
    ...
    void testErrorInfoToString() {
        ...
        ToolErrorRecoveryManager.ErrorInfo errorInfo = new ToolErrorRecoveryManager.ErrorInfo(2,
                System.currentTimeMillis(), "Test error", null);
    ...
    void testErrorInfoEquality() {
        ...
        ToolErrorRecoveryManager.ErrorInfo errorInfo1 = new ToolErrorRecoveryManager.ErrorInfo(1, timestamp,
                "Test error", null);

        ToolErrorRecoveryManager.ErrorInfo errorInfo2 = new ToolErrorRecoveryManager.ErrorInfo(1, timestamp,
                "Test error", null);

        ToolErrorRecoveryManager.ErrorInfo errorInfo3 = new ToolErrorRecoveryManager.ErrorInfo(2, timestamp,
                "Test error", null);
    ...
    void testRecoveryActionEnum() {
        ...
        ToolErrorRecoveryManager.RecoveryAction[] actions = ToolErrorRecoveryManager.RecoveryAction.values();
        assertEquals(3, actions.length);

        assertTrue(containsAction(actions, ToolErrorRecoveryManager.RecoveryAction.RETRY));
        assertTrue(containsAction(actions, ToolErrorRecoveryManager.RecoveryAction.FALLBACK));
        assertTrue(containsAction(actions, ToolErrorRecoveryManager.RecoveryAction.DEGRADE));
    }

    @Test
    void testRecoveryActionValueOf() {
        // Test RecoveryAction valueOf method
        assertEquals(ToolErrorRecoveryManager.RecoveryAction.RETRY,
                ToolErrorRecoveryManager.RecoveryAction.valueOf("RETRY"));
        assertEquals(ToolErrorRecoveryManager.RecoveryAction.FALLBACK,
                ToolErrorRecoveryManager.RecoveryAction.valueOf("FALLBACK"));
        assertEquals(ToolErrorRecoveryManager.RecoveryAction.DEGRADE,
                ToolErrorRecoveryManager.RecoveryAction.valueOf("DEGRADE"));
    }
    ...
    void testRecoveryActionValueOfInvalid() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            ToolErrorRecoveryManager.RecoveryAction.valueOf("INVALID");
        });
    }
    ...
    void testEquality() {
        // Test equality
        ToolErrorRecoveryManager manager1 = new ToolErrorRecoveryManager(auditLogger);
        ToolErrorRecoveryManager manager2 = new ToolErrorRecoveryManager(auditLogger);
    ...
    private boolean containsAction(ToolErrorRecoveryManager.RecoveryAction[] actions,
            ToolErrorRecoveryManager.RecoveryAction target) {
        for (ToolErrorRecoveryManager.RecoveryAction action : actions) {
            if (action == target) {
                return true;
            }
        }
