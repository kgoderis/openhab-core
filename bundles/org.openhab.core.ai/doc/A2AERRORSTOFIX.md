...
## 5. AgentSecurityManager Method Signature Issues (3 errors)
...
**Locations**:
- `AgentSecurityManager.java` lines 85, 90, 95
...
**Locations**:
- `AgentSkillRegistry.java` lines 375, 380, 385
...
- `AgentOpenHABPersistenceManager.recoveryStorage` - Field not used
- `AgentOpenHABPersistenceManager.totalExecutionTime` - Field not used
...
- `AgentOpenHABPersistenceManager.java:152` - Potential null pointer access
